...
#       #   .to return(status: 200, body: patient.to_json)
      
#       # stub_request(:get, "#{url}/#{encounter_ref}")
#       #   .to return(status: 200, body: encounter.to_json)

#       # stub_request(:get, "#{url}/#{practitioner_ref}")
#       #   .to return(status: 200, body: practitioner.to_json)

#       # stub_request(:get, "#{url}/#{organization_ref}")
#       #   .to return(status: 200, body: organization.to_json)
