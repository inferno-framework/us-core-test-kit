  ...
  module Client
    module USCoreClientV800
      class ProcedureClientGroup < Inferno::TestGroup
        id :us_core_client_v800_procedure
        title 'Procedure'
        description %(
...
* patient + code + date
        ...
        test from: :us_core_v800_procedure_client_read_test
        test from: :us_core_v800_procedure_patient_client_search_test
        test from: :us_core_v800_procedure_patient_status_client_search_test
        test from: :us_core_v800_procedure_patient_date_client_search_test
        test from: :us_core_v800_procedure_patient_code_date_client_search_test
      end
    end
  end
end
