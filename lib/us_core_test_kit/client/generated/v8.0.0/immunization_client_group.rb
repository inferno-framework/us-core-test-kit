  ...
  module Client
    module USCoreClientV800
      class ImmunizationClientGroup < Inferno::TestGroup
        id :us_core_client_v800_immunization
        title 'Immunization'
        description %(
...
* patient + date
        ...
        test from: :us_core_v800_immunization_client_read_test
        test from: :us_core_v800_immunization_patient_client_search_test
        test from: :us_core_v800_immunization_patient_status_client_search_test
        test from: :us_core_v800_immunization_patient_date_client_search_test
      end
    end
  end
end
