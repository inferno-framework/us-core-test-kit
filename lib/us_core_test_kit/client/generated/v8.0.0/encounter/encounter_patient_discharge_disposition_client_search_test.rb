...
module USCoreTestKit
  module Client
    module USCoreClientV800
      class EncounterPatientDischargeDispositionClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v800_encounter_patient_discharge_disposition_client_search_test
        title 'SHOULD support patient + discharge-disposition search of Encounter'
        description %(
          The client demonstrates SHOULD support for searching patient + discharge-disposition on Encounter.
        )
        optional true
