...
module USCoreTestKit
  module Client
    module USCoreClientV800
      class AdiDocumentReferencePatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v800_adi_document_reference_patient_status_client_search_test
        title 'SHOULD support patient + status search of AdiDocumentReference'
        description %(
          The client demonstrates SHOULD support for searching patient + status on AdiDocumentReference.
        )
        optional true
