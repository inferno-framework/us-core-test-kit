...
module USCoreTestKit
  module Client
    module USCoreClientV800
      class AdiDocumentReferencePatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v800_adi_document_reference_patient_category_client_search_test
        title 'SHALL support patient + category search of AdiDocumentReference'
        description %(
          The client demonstrates SHALL support for searching patient + category on AdiDocumentReference.
        )
        optional false
