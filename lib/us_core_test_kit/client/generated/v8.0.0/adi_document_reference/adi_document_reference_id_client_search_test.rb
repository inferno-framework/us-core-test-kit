...
module USCoreTestKit
  module Client
    module USCoreClientV800
      class AdiDocumentReferenceIdClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v800_adi_document_reference_id_client_search_test
        title 'SHALL support _id search of AdiDocumentReference'
        description %(
          The client demonstrates SHALL support for searching _id on AdiDocumentReference.
        )
        optional false
