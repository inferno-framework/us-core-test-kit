...
module USCoreTestKit
  module Client
    module USCoreClientV800
      class AdiDocumentReferencePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v800_adi_document_reference_patient_client_search_test
        title 'SHALL support patient search of AdiDocumentReference'
        description %(
          The client demonstrates SHALL support for searching patient on AdiDocumentReference.
        )
        optional false
