  ...
  module Client
    module USCoreClientV800
      class WaitGroup < Inferno::TestGroup
        ...
        id :us_core_client_access_group_v800
        title 'Client Access'
        description %(
        ...
        group do
          id :us_core_client_wait_group_v800
          title 'Perform Data Access'

          test do
            id :us_core_client_wait_test_v800
