  ...
  module Client
    module USCoreClientV800
      class RegistrationGroup < Inferno::TestGroup
        id :us_core_client_v800_registration
        ...
        test from: :us_core_client_v800_reg_config_smart_display,
              id: :us_core_client_v800_reg_config_smart_alca_display,
              required_suite_options: {
                client_type: USCoreClientOptions::SMART_APP_LAUNCH_CONFIDENTIAL_ASYMMETRIC
              }
        test from: :us_core_client_v800_reg_config_smart_display,
              id: :us_core_client_v800_reg_config_smart_alcs_display,
              required_suite_options: {
                client_type: USCoreClientOptions::SMART_APP_LAUNCH_CONFIDENTIAL_SYMMETRIC
              }
        test from: :us_core_client_v800_reg_config_smart_display,
              id: :us_core_client_v800_reg_config_smart_alp_display,
              required_suite_options: {
                client_type: USCoreClientOptions::SMART_APP_LAUNCH_PUBLIC
              }
      end
