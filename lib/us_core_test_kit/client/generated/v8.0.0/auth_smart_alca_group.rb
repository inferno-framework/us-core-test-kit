  ...
  module Client
    module USCoreClientV800
      class AuthSMARTConfidentialAsymmetricGroup < Inferno::TestGroup
        id :us_core_client_v800_auth_smart_alca
        ...
        test from: :smart_client_authorization_request_verification,
            id: :us_core_client_v800_authorization_smart_alca_verification,
            config: { options: { endpoint_suite_id: :us_core_client_v800 } }
        test from: :smart_client_token_request_alca_verification,
            id: :us_core_client_v800_token_smart_alca_verification,
            config: { options: { endpoint_suite_id: :us_core_client_v800 } }
