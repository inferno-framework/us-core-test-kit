  ...
  module Client
    module USCoreClientV800
      class PractitionerClientGroup < Inferno::TestGroup
        id :us_core_client_v800_practitioner
        title 'Practitioner'
        description %(
...
* _id
        ...
        test from: :us_core_v800_practitioner_client_read_test
        test from: :us_core_v800_practitioner_id_client_search_test
        test from: :us_core_v800_practitioner_identifier_client_search_test
        test from: :us_core_v800_practitioner_name_client_search_test
      end
    end
  end
end
