...
module USCoreTestKit
  module Client
    module USCoreClientV800
      class DiagnosticReportLabPatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v800_diagnostic_report_lab_patient_status_client_search_test
        title 'SHOULD support patient + status search of DiagnosticReportLab'
        description %(
          The client demonstrates SHOULD support for searching patient + status on DiagnosticReportLab.
        )
        optional true
