  ...
  module Client
    module USCoreClientV800
      class LocationClientGroup < Inferno::TestGroup
        id :us_core_client_v800_location
        title 'Location'
        description %(
...
* address-state
        ...
        test from: :us_core_v800_location_client_read_test
        test from: :us_core_v800_location_address_client_search_test
        test from: :us_core_v800_location_address_city_client_search_test
        test from: :us_core_v800_location_address_postalcode_client_search_test
        test from: :us_core_v800_location_address_state_client_search_test
        test from: :us_core_v800_location_name_client_search_test
      end
    end
  end
end
