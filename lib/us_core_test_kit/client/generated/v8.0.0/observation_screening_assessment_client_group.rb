...
require_relative 'observation_screening_assessment/observation_screening_assessment_patient_category_lastupdated_client_search_test'
  ...
  module Client
    module USCoreClientV800
      class ObservationScreeningAssessmentClientGroup < Inferno::TestGroup
        id :us_core_client_v800_observation_screening_assessment
...
* patient + code + date
        ...
        test from: :us_core_v800_observation_screening_assessment_client_read_test
        test from: :us_core_v800_observation_screening_assessment_patient_category_client_search_test
        test from: :us_core_v800_observation_screening_assessment_patient_category_lastupdated_client_search_test
        test from: :us_core_v800_observation_screening_assessment_patient_category_status_client_search_test
        test from: :us_core_v800_observation_screening_assessment_patient_category_date_client_search_test
        test from: :us_core_v800_observation_screening_assessment_patient_code_client_search_test
        test from: :us_core_v800_observation_screening_assessment_patient_code_date_client_search_test
      end
    end
  end
end
