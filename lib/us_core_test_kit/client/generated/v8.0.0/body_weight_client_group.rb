  ...
  module Client
    module USCoreClientV800
      class BodyWeightClientGroup < Inferno::TestGroup
        id :us_core_client_v800_body_weight
...
* patient + code + date
        ...
        test from: :us_core_v800_body_weight_client_read_test
        test from: :us_core_v800_body_weight_patient_code_client_search_test
        test from: :us_core_v800_body_weight_patient_category_lastupdated_client_search_test
        test from: :us_core_v800_body_weight_patient_category_client_search_test
        test from: :us_core_v800_body_weight_patient_category_status_client_search_test
        test from: :us_core_v800_body_weight_patient_category_date_client_search_test
        test from: :us_core_v800_body_weight_patient_code_date_client_search_test
      end
    end
  end
end
