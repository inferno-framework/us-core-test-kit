  ...
  module Client
    module USCoreClientV800
      class SpecimenClientGroup < Inferno::TestGroup
        id :us_core_client_v800_specimen
        title 'Specimen'
        description %(
...
* patient
        ...
        test from: :us_core_v800_specimen_client_read_test
        test from: :us_core_v800_specimen_patient_client_search_test
        test from: :us_core_v800_specimen_id_client_search_test
      end
    end
  end
end
