  ...
  module Client
    module USCoreClientV800
      class USCoreClientTestSuite < Inferno::TestSuite
        ...
        id :us_core_client_v800
        title 'US Core Client v8.0.0'
        description %(
...
- Check the Must Support Conformance Requirements for clients/requestors specified in US Core IG v8.0.0
...
- Allow testers to bring their own data. Testers must manually configure their client system to connect
  to a specific target patient and must access and process specific curated sample US Core data.
        ...
        route(:get, METADATA_PATH, USCoreTestKit::Client::MetadataHelper.get_metadata('v800'))
        ...
        group from: :us_core_client_v800_registration

        group do
          id :us_core_client_read_search_group_v800
          title 'Read & Search'
          description %(
...
and demonstrate its ability to perform the FHIR interactions described in the [US Core Client CapabilityStatement](http://hl7.org/fhir/us/core/STU8/CapabilityStatement-us-core-client.html).
          ...
          group from: :us_core_client_access_group_v800

          group from: :us_core_client_v800_patient
          group from: :us_core_client_v800_allergy_intolerance
          group from: :us_core_client_v800_care_plan
          group from: :us_core_client_v800_care_team
          group from: :us_core_client_v800_condition_encounter_diagnosis
          group from: :us_core_client_v800_condition_problems_health_concerns
          group from: :us_core_client_v800_coverage
          group from: :us_core_client_v800_device
          group from: :us_core_client_v800_diagnostic_report_note
          ...
          group from: :us_core_client_v800_observation_occupation
          group from: :us_core_client_v800_respiratory_rate
          group from: :us_core_client_v800_simple_observation
          group from: :us_core_client_v800_treatment_intervention_preference
          group from: :us_core_client_v800_care_experience_preference
          group from: :us_core_client_v800_heart_rate
          group from: :us_core_client_v800_body_temperature
          group from: :us_core_client_v800_pediatric_weight_for_height
          group from: :us_core_client_v800_pulse_oximetry
          group from: :us_core_client_v800_smokingstatus
          group from: :us_core_client_v800_observation_sexual_orientation
          group from: :us_core_client_v800_head_circumference
          group from: :us_core_client_v800_body_height
          group from: :us_core_client_v800_bmi
          group from: :us_core_client_v800_observation_screening_assessment
          group from: :us_core_client_v800_average_blood_pressure
          group from: :us_core_client_v800_blood_pressure
          group from: :us_core_client_v800_observation_clinical_result
          ...
          group from: :us_core_client_v800_location
          group from: :us_core_client_v800_organization
          group from: :us_core_client_v800_practitioner
          group from: :us_core_client_v800_practitioner_role
          group from: :us_core_client_v800_provenance
          group from: :us_core_client_v800_related_person
          group from: :us_core_client_v800_specimen
