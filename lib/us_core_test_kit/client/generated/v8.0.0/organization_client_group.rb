  ...
  module Client
    module USCoreClientV800
      class OrganizationClientGroup < Inferno::TestGroup
        id :us_core_client_v800_organization
        title 'Organization'
        description %(
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_core_v800_organization_client_read_test
        test from: :us_core_v800_organization_address_client_search_test
        test from: :us_core_v800_organization_name_client_search_test
      end
    end
  end
end
