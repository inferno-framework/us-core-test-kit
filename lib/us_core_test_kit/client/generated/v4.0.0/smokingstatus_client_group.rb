  ...
  module Client
    module USCoreClientV400
      class SmokingstatusClientGroup < Inferno::TestGroup
        id :us_core_client_v400_smokingstatus
...
* patient + category
        ...
        test from: :us_core_v400_smokingstatus_client_support_test
        test from: :us_core_v400_smokingstatus_client_read_test
        test from: :us_core_v400_smokingstatus_patient_code_client_search_test
        test from: :us_core_v400_smokingstatus_status_client_search_test
        test from: :us_core_v400_smokingstatus_category_client_search_test
        test from: :us_core_v400_smokingstatus_code_client_search_test
        test from: :us_core_v400_smokingstatus_date_client_search_test
        test from: :us_core_v400_smokingstatus_patient_client_search_test
        test from: :us_core_v400_smokingstatus_patient_category_status_client_search_test
        test from: :us_core_v400_smokingstatus_patient_code_date_client_search_test
        test from: :us_core_v400_smokingstatus_patient_category_date_client_search_test
        test from: :us_core_v400_smokingstatus_patient_category_client_search_test
      end
    end
  end
end
