...
require_relative 'condition/condition_client_support_test'
  ...
  module Client
    module USCoreClientV400
      class ConditionClientGroup < Inferno::TestGroup
        id :us_core_client_v400_condition
        title 'Condition'
        description %(
...
* patient + category
        ...
        test from: :us_core_v400_condition_client_support_test
        test from: :us_core_v400_condition_client_read_test
        test from: :us_core_v400_condition_patient_client_search_test
        test from: :us_core_v400_condition_category_client_search_test
        test from: :us_core_v400_condition_clinical_status_client_search_test
        test from: :us_core_v400_condition_onset_date_client_search_test
        test from: :us_core_v400_condition_code_client_search_test
        test from: :us_core_v400_condition_patient_code_client_search_test
        test from: :us_core_v400_condition_patient_onset_date_client_search_test
        test from: :us_core_v400_condition_patient_clinical_status_client_search_test
        test from: :us_core_v400_condition_patient_category_client_search_test
      end
    end
  end
end
