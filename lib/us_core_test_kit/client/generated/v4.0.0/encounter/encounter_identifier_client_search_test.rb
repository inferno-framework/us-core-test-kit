...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class EncounterIdentifierClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_encounter_identifier_client_search_test
        title 'SHOULD support identifier search of Encounter'
        description %(
          The client demonstrates SHOULD support for searching identifier on Encounter.
        )
        optional true
