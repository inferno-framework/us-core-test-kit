...
require_relative 'body_height/body_height_client_support_test'
require_relative 'body_height/body_height_patient_code_client_search_test'
require_relative 'body_height/body_height_status_client_search_test'
require_relative 'body_height/body_height_category_client_search_test'
require_relative 'body_height/body_height_code_client_search_test'
require_relative 'body_height/body_height_date_client_search_test'
require_relative 'body_height/body_height_patient_client_search_test'
...
* patient + category
        ...
        test from: :us_core_v400_body_height_client_support_test
        test from: :us_core_v400_body_height_client_read_test
        test from: :us_core_v400_body_height_patient_code_client_search_test
        test from: :us_core_v400_body_height_status_client_search_test
        test from: :us_core_v400_body_height_category_client_search_test
        test from: :us_core_v400_body_height_code_client_search_test
        test from: :us_core_v400_body_height_date_client_search_test
        test from: :us_core_v400_body_height_patient_client_search_test
        test from: :us_core_v400_body_height_patient_category_status_client_search_test
        test from: :us_core_v400_body_height_patient_code_date_client_search_test
