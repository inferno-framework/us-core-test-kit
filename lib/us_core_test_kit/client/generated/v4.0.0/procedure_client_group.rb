...
require_relative 'procedure/procedure_client_support_test'
require_relative 'procedure/procedure_patient_client_search_test'
require_relative 'procedure/procedure_status_client_search_test'
require_relative 'procedure/procedure_date_client_search_test'
require_relative 'procedure/procedure_code_client_search_test'
  ...
  module Client
    module USCoreClientV400
      class ProcedureClientGroup < Inferno::TestGroup
        id :us_core_client_v400_procedure
        title 'Procedure'
        description %(
...
* patient + date
        ...
        test from: :us_core_v400_procedure_client_support_test
        test from: :us_core_v400_procedure_client_read_test
        test from: :us_core_v400_procedure_patient_client_search_test
        test from: :us_core_v400_procedure_status_client_search_test
        test from: :us_core_v400_procedure_date_client_search_test
        test from: :us_core_v400_procedure_code_client_search_test
        test from: :us_core_v400_procedure_patient_code_date_client_search_test
        test from: :us_core_v400_procedure_patient_status_client_search_test
        test from: :us_core_v400_procedure_patient_date_client_search_test
      end
    end
  end
end
