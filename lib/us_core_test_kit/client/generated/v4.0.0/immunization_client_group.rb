  ...
  module Client
    module USCoreClientV400
      class ImmunizationClientGroup < Inferno::TestGroup
        id :us_core_client_v400_immunization
        title 'Immunization'
        description %(
...
* patient + date
        ...
        test from: :us_core_v400_immunization_client_support_test
        test from: :us_core_v400_immunization_client_read_test
        test from: :us_core_v400_immunization_patient_client_search_test
        test from: :us_core_v400_immunization_status_client_search_test
        test from: :us_core_v400_immunization_date_client_search_test
        test from: :us_core_v400_immunization_patient_status_client_search_test
        test from: :us_core_v400_immunization_patient_date_client_search_test
      end
    end
  end
end
