  ...
  module Client
    module USCoreClientV400
      class ProcedurePatientDateClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_procedure_patient_date_client_search_test
        title 'SHOULD support patient + date search of Procedure'
        description %(
          The client demonstrates SHOULD support for searching patient + date on Procedure.
        )
        optional true
