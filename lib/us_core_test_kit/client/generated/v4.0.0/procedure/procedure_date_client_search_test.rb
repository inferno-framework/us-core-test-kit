...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class ProcedureDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_procedure_date_client_search_test
        title 'SHOULD support date search of Procedure'
        description %(
          The client demonstrates SHOULD support for searching date on Procedure.
        )
        optional true
