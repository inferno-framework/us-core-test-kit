...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class ProcedureStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_procedure_status_client_search_test
        title 'SHOULD support status search of Procedure'
        description %(
          The client demonstrates SHOULD support for searching status on Procedure.
        )
        optional true
