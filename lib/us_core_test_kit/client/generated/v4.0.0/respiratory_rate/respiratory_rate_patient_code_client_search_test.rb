...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class RespiratoryRatePatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_respiratory_rate_patient_code_client_search_test
        title 'SHOULD support patient + code search of RespiratoryRate'
        description %(
          The client demonstrates SHOULD support for searching patient + code on RespiratoryRate.
        )
        optional true
