...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class RespiratoryRateDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_respiratory_rate_date_client_search_test
        title 'SHOULD support date search of RespiratoryRate'
        description %(
          The client demonstrates SHOULD support for searching date on RespiratoryRate.
        )
        optional true
