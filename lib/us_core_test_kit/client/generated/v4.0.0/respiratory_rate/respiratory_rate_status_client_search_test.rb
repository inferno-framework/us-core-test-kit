...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class RespiratoryRateStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_respiratory_rate_status_client_search_test
        title 'SHOULD support status search of RespiratoryRate'
        description %(
          The client demonstrates SHOULD support for searching status on RespiratoryRate.
        )
        optional true
