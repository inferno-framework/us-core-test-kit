...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class RespiratoryRateCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_respiratory_rate_category_client_search_test
        title 'SHOULD support category search of RespiratoryRate'
        description %(
          The client demonstrates SHOULD support for searching category on RespiratoryRate.
        )
        optional true
