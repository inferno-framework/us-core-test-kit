...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class RespiratoryRatePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_respiratory_rate_patient_client_search_test
        title 'SHOULD support patient search of RespiratoryRate'
        description %(
          The client demonstrates SHOULD support for searching patient on RespiratoryRate.
        )
        optional true
