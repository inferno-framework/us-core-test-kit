  ...
  module Client
    module USCoreClientV400
      class HeadCircumferencePercentilePatientCategoryDateClientSearchTest < Inferno::Test
        ...
        title 'SHALL support patient + category + date search of HeadCircumferencePercentile'

        description %(
          The client demonstrates SHALL support for searching patient + category + date on HeadCircumferencePercentile.
        )
