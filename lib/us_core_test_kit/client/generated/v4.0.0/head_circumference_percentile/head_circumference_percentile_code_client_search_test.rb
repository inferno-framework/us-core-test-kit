...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class HeadCircumferencePercentileCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_head_circumference_percentile_code_client_search_test
        title 'SHOULD support code search of HeadCircumferencePercentile'
        description %(
          The client demonstrates SHOULD support for searching code on HeadCircumferencePercentile.
        )
        optional true
