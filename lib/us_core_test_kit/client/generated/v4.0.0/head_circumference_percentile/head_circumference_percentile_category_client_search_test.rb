...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class HeadCircumferencePercentileCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_head_circumference_percentile_category_client_search_test
        title 'SHOULD support category search of HeadCircumferencePercentile'
        description %(
          The client demonstrates SHOULD support for searching category on HeadCircumferencePercentile.
        )
        optional true
