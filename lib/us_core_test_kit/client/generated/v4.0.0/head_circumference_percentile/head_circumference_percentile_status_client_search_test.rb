...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class HeadCircumferencePercentileStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_head_circumference_percentile_status_client_search_test
        title 'SHOULD support status search of HeadCircumferencePercentile'
        description %(
          The client demonstrates SHOULD support for searching status on HeadCircumferencePercentile.
        )
        optional true
