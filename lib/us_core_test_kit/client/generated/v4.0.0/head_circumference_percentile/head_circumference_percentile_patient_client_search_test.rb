...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class HeadCircumferencePercentilePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_head_circumference_percentile_patient_client_search_test
        title 'SHOULD support patient search of HeadCircumferencePercentile'
        description %(
          The client demonstrates SHOULD support for searching patient on HeadCircumferencePercentile.
        )
        optional true
