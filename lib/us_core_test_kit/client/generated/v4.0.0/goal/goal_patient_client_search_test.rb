  ...
  module Client
    module USCoreClientV400
      class GoalPatientClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_goal_patient_client_search_test
        title 'SHOULD support patient search of Goal'
        description %(
          The client demonstrates SHOULD support for searching patient on Goal.
        )
        optional true
