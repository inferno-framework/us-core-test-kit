...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class GoalLifecycleStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_goal_lifecycle_status_client_search_test
        title 'SHOULD support lifecycle-status search of Goal'
        description %(
          The client demonstrates SHOULD support for searching lifecycle-status on Goal.
        )
        optional true
