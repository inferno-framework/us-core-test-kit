  ...
  module Client
    module USCoreClientV400
      class HeartRatePatientCodeClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_heart_rate_patient_code_client_search_test
        title 'SHOULD support patient + code search of HeartRate'
        description %(
          The client demonstrates SHOULD support for searching patient + code on HeartRate.
        )
        optional true
