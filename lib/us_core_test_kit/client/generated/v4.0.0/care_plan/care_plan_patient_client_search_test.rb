...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class CarePlanPatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_care_plan_patient_client_search_test
        title 'SHOULD support patient search of CarePlan'
        description %(
          The client demonstrates SHOULD support for searching patient on CarePlan.
        )
        optional true
