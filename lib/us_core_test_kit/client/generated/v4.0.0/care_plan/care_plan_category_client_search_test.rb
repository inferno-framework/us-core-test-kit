...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class CarePlanCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_care_plan_category_client_search_test
        title 'SHOULD support category search of CarePlan'
        description %(
          The client demonstrates SHOULD support for searching category on CarePlan.
        )
        optional true
