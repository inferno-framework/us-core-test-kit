  ...
  module Client
    module USCoreClientV400
      class BmiPatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_bmi_patient_category_client_search_test
        title 'SHOULD support patient + category search of Bmi'
        description %(
          The client demonstrates SHOULD support for searching patient + category on Bmi.
        )
        optional true
