...
* patient + target-date
        ...
        test from: :us_core_v400_goal_client_support_test
        test from: :us_core_v400_goal_client_read_test
        test from: :us_core_v400_goal_patient_client_search_test
        test from: :us_core_v400_goal_lifecycle_status_client_search_test
        test from: :us_core_v400_goal_target_date_client_search_test
        test from: :us_core_v400_goal_patient_lifecycle_status_client_search_test
        test from: :us_core_v400_goal_patient_target_date_client_search_test
      end
    end
  end
end
