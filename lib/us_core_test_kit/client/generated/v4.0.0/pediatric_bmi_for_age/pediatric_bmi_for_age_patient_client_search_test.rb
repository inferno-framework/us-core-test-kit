...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class PediatricBmiForAgePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_pediatric_bmi_for_age_patient_client_search_test
        title 'SHOULD support patient search of PediatricBmiForAge'
        description %(
          The client demonstrates SHOULD support for searching patient on PediatricBmiForAge.
        )
        optional true
