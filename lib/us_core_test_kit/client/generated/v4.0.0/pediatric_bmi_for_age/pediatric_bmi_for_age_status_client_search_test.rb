...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class PediatricBmiForAgeStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_pediatric_bmi_for_age_status_client_search_test
        title 'SHOULD support status search of PediatricBmiForAge'
        description %(
          The client demonstrates SHOULD support for searching status on PediatricBmiForAge.
        )
        optional true
