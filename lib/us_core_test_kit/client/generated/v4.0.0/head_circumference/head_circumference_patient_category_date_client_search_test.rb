  ...
  module Client
    module USCoreClientV400
      class HeadCircumferencePatientCategoryDateClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_head_circumference_patient_category_date_client_search_test
        title 'SHOULD support patient + category + date search of HeadCircumference'
        description %(
          The client demonstrates SHOULD support for searching patient + category + date on HeadCircumference.
        )
        optional true
