  ...
  module Client
    module USCoreClientV400
      class HeadCircumferenceClientSupportTest < Inferno::Test
        ...
        id :us_core_v400_head_circumference_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-head-circumference-percentile` for the US Core Head Circumference Profile.
