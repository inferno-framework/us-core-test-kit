...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class HeadCircumferenceDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_head_circumference_date_client_search_test
        title 'SHOULD support date search of HeadCircumference'
        description %(
          The client demonstrates SHOULD support for searching date on HeadCircumference.
        )
        optional true
