  ...
  module Client
    module USCoreClientV400
      class BodyTemperaturePatientCategoryDateClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_body_temperature_patient_category_date_client_search_test
        title 'SHOULD support patient + category + date search of BodyTemperature'
        description %(
          The client demonstrates SHOULD support for searching patient + category + date on BodyTemperature.
        )
        optional true
