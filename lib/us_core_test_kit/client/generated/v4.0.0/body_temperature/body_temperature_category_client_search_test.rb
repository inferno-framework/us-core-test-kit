...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class BodyTemperatureCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_body_temperature_category_client_search_test
        title 'SHOULD support category search of BodyTemperature'
        description %(
          The client demonstrates SHOULD support for searching category on BodyTemperature.
        )
        optional true
