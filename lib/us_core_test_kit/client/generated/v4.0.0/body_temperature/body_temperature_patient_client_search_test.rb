...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class BodyTemperaturePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_body_temperature_patient_client_search_test
        title 'SHOULD support patient search of BodyTemperature'
        description %(
          The client demonstrates SHOULD support for searching patient on BodyTemperature.
        )
        optional true
