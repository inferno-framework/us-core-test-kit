...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class BodyTemperatureStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_body_temperature_status_client_search_test
        title 'SHOULD support status search of BodyTemperature'
        description %(
          The client demonstrates SHOULD support for searching status on BodyTemperature.
        )
        optional true
