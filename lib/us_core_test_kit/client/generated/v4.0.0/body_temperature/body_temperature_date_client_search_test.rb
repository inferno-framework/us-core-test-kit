...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class BodyTemperatureDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_body_temperature_date_client_search_test
        title 'SHOULD support date search of BodyTemperature'
        description %(
          The client demonstrates SHOULD support for searching date on BodyTemperature.
        )
        optional true
