...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class BodyTemperatureCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_body_temperature_code_client_search_test
        title 'SHOULD support code search of BodyTemperature'
        description %(
          The client demonstrates SHOULD support for searching code on BodyTemperature.
        )
        optional true
