...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class BodyTemperaturePatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_body_temperature_patient_code_client_search_test
        title 'SHOULD support patient + code search of BodyTemperature'
        description %(
          The client demonstrates SHOULD support for searching patient + code on BodyTemperature.
        )
        optional true
