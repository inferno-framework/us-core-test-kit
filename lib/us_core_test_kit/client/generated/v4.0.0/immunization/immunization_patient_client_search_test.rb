  ...
  module Client
    module USCoreClientV400
      class ImmunizationPatientClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_immunization_patient_client_search_test
        title 'SHOULD support patient search of Immunization'
        description %(
          The client demonstrates SHOULD support for searching patient on Immunization.
        )
        optional true
