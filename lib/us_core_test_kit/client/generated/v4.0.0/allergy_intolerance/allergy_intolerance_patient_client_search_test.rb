  ...
  module Client
    module USCoreClientV400
      class AllergyIntolerancePatientClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_allergy_intolerance_patient_client_search_test
        ...
        def failure_message
          "Did not recieve a request for `AllergyIntolerance` with required search parameters: `#{required_params.join(' + ')}`"
        end
