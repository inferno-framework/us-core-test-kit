...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class BloodPressureClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v400_blood_pressure_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-blood-pressure` for the US Core Blood Pressure Profile.
