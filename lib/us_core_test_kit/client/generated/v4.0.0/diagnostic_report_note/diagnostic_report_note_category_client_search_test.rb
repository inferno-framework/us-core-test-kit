...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class DiagnosticReportNoteCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_diagnostic_report_note_category_client_search_test
        title 'SHOULD support category search of DiagnosticReportNote'
        description %(
          The client demonstrates SHOULD support for searching category on DiagnosticReportNote.
        )
        optional true
