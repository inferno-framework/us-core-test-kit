...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class DiagnosticReportNoteCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_diagnostic_report_note_code_client_search_test
        title 'SHOULD support code search of DiagnosticReportNote'
        description %(
          The client demonstrates SHOULD support for searching code on DiagnosticReportNote.
        )
        optional true
