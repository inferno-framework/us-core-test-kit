...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class ConditionPatientOnsetDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_condition_patient_onset_date_client_search_test
        title 'SHOULD support patient + onset-date search of Condition'
        description %(
          The client demonstrates SHOULD support for searching patient + onset-date on Condition.
        )
        optional true
