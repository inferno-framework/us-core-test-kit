...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class ConditionCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_condition_category_client_search_test
        title 'SHOULD support category search of Condition'
        description %(
          The client demonstrates SHOULD support for searching category on Condition.
        )
        optional true
