...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class ConditionPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_condition_patient_code_client_search_test
        title 'SHOULD support patient + code search of Condition'
        description %(
          The client demonstrates SHOULD support for searching patient + code on Condition.
        )
        optional true
