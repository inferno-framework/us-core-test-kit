...
require_relative 'bmi/bmi_client_support_test'
require_relative 'bmi/bmi_patient_code_client_search_test'
require_relative 'bmi/bmi_status_client_search_test'
require_relative 'bmi/bmi_category_client_search_test'
require_relative 'bmi/bmi_code_client_search_test'
require_relative 'bmi/bmi_date_client_search_test'
require_relative 'bmi/bmi_patient_client_search_test'
...
* patient + category
        ...
        test from: :us_core_v400_bmi_client_support_test
        test from: :us_core_v400_bmi_client_read_test
        test from: :us_core_v400_bmi_patient_code_client_search_test
        test from: :us_core_v400_bmi_status_client_search_test
        test from: :us_core_v400_bmi_category_client_search_test
        test from: :us_core_v400_bmi_code_client_search_test
        test from: :us_core_v400_bmi_date_client_search_test
        test from: :us_core_v400_bmi_patient_client_search_test
        test from: :us_core_v400_bmi_patient_category_status_client_search_test
        test from: :us_core_v400_bmi_patient_code_date_client_search_test
