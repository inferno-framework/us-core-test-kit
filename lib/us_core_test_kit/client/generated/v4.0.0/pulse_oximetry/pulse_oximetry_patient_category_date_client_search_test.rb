...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class PulseOximetryPatientCategoryDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_pulse_oximetry_patient_category_date_client_search_test
        title 'SHOULD support patient + category + date search of PulseOximetry'
        description %(
          The client demonstrates SHOULD support for searching patient + category + date on PulseOximetry.
        )
        optional true
