...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class PulseOximetryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_pulse_oximetry_status_client_search_test
        title 'SHOULD support status search of PulseOximetry'
        description %(
          The client demonstrates SHOULD support for searching status on PulseOximetry.
        )
        optional true
