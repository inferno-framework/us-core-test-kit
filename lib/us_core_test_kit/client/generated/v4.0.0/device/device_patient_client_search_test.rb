  ...
  module Client
    module USCoreClientV400
      class DevicePatientClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_device_patient_client_search_test
        title 'SHOULD support patient search of Device'
        description %(
          The client demonstrates SHOULD support for searching patient on Device.
        )
        optional true
