...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class DiagnosticReportLabPatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_diagnostic_report_lab_patient_client_search_test
        title 'SHOULD support patient search of DiagnosticReportLab'
        description %(
          The client demonstrates SHOULD support for searching patient on DiagnosticReportLab.
        )
        optional true
