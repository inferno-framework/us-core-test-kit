...
require_relative 'care_team/care_team_patient_client_search_test'
require_relative 'care_team/care_team_status_client_search_test'

module USCoreTestKit
  module Client
    module USCoreClientV400
      class CareTeamClientGroup < Inferno::TestGroup
        id :us_core_client_v400_care_team
        title 'CareTeam'
        description %(
...
* status
        ...
        test from: :us_core_v400_care_team_client_support_test
        test from: :us_core_v400_care_team_client_read_test
        test from: :us_core_v400_care_team_patient_status_client_search_test
        test from: :us_core_v400_care_team_patient_client_search_test
        test from: :us_core_v400_care_team_status_client_search_test
      end
    end
  end
end
