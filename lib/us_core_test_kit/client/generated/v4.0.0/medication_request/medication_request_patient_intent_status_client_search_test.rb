  ...
  module Client
    module USCoreClientV400
      class MedicationRequestPatientIntentStatusClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_medication_request_patient_intent_status_client_search_test
        title 'SHOULD support patient + intent + status search of MedicationRequest'
        description %(
          The client demonstrates SHOULD support for searching patient + intent + status on MedicationRequest.
        )
        optional true
