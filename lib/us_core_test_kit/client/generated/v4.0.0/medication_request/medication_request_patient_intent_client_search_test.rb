  ...
  module Client
    module USCoreClientV400
      class MedicationRequestPatientIntentClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_medication_request_patient_intent_client_search_test
        title 'SHOULD support patient + intent search of MedicationRequest'
        description %(
          The client demonstrates SHOULD support for searching patient + intent on MedicationRequest.
        )
        optional true
