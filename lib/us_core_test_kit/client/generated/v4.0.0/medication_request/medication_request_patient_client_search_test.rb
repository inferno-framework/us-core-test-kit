...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class MedicationRequestPatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_medication_request_patient_client_search_test
        title 'SHOULD support patient search of MedicationRequest'
        description %(
          The client demonstrates SHOULD support for searching patient on MedicationRequest.
        )
        optional true
