  ...
  module Client
    module USCoreClientV400
      class BodyHeightPatientCodeClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_body_height_patient_code_client_search_test
        title 'SHOULD support patient + code search of BodyHeight'
        description %(
          The client demonstrates SHOULD support for searching patient + code on BodyHeight.
        )
        optional true
