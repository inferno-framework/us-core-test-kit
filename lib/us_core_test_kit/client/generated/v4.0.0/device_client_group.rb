...
* patient + type
        ...
        test from: :us_core_v400_device_client_support_test
        test from: :us_core_v400_device_client_read_test
        test from: :us_core_v400_device_patient_client_search_test
        test from: :us_core_v400_device_type_client_search_test
        test from: :us_core_v400_device_patient_type_client_search_test
      end
    end
  end
end
