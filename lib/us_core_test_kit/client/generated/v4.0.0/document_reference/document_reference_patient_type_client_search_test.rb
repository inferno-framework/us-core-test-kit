  ...
  module Client
    module USCoreClientV400
      class DocumentReferencePatientTypeClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_document_reference_patient_type_client_search_test
        title 'SHOULD support patient + type search of DocumentReference'
        description %(
          The client demonstrates SHOULD support for searching patient + type on DocumentReference.
        )
        optional true
