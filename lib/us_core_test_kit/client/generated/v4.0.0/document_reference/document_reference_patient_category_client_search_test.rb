  ...
  module Client
    module USCoreClientV400
      class DocumentReferencePatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v400_document_reference_patient_category_client_search_test
        title 'SHOULD support patient + category search of DocumentReference'
        description %(
          The client demonstrates SHOULD support for searching patient + category on DocumentReference.
        )
        optional true
