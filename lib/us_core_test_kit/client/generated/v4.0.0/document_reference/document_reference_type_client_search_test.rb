...
module USCoreTestKit
  module Client
    module USCoreClientV400
      class DocumentReferenceTypeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v400_document_reference_type_client_search_test
        title 'SHOULD support type search of DocumentReference'
        description %(
          The client demonstrates SHOULD support for searching type on DocumentReference.
        )
        optional true
