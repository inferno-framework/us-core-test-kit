...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DiagnosticReportLabDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_diagnostic_report_lab_date_client_search_test
        title 'SHOULD support date search of DiagnosticReportLab'
        description %(
          The client demonstrates SHOULD support for searching date on DiagnosticReportLab.
        )
        optional true
