  ...
  module Client
    module USCoreClientV311
      class DiagnosticReportLabPatientCodeClientSearchTest < Inferno::Test
        ...
        id :us_core_v311_diagnostic_report_lab_patient_code_client_search_test
        title 'SHOULD support patient + code search of DiagnosticReportLab'
        description %(
          The client demonstrates SHOULD support for searching patient + code on DiagnosticReportLab.
        )
        optional true
