  ...
  module Client
    module USCoreClientV311
      class DiagnosticReportLabPatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v311_diagnostic_report_lab_patient_category_client_search_test
        title 'SHOULD support patient + category search of DiagnosticReportLab'
        description %(
          The client demonstrates SHOULD support for searching patient + category on DiagnosticReportLab.
        )
        optional true
