...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DiagnosticReportLabCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_diagnostic_report_lab_category_client_search_test
        title 'SHOULD support category search of DiagnosticReportLab'
        description %(
          The client demonstrates SHOULD support for searching category on DiagnosticReportLab.
        )
        optional true
