...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DiagnosticReportLabStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_diagnostic_report_lab_status_client_search_test
        title 'SHOULD support status search of DiagnosticReportLab'
        description %(
          The client demonstrates SHOULD support for searching status on DiagnosticReportLab.
        )
        optional true
