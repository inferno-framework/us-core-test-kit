...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DiagnosticReportLabCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_diagnostic_report_lab_code_client_search_test
        title 'SHOULD support code search of DiagnosticReportLab'
        description %(
          The client demonstrates SHOULD support for searching code on DiagnosticReportLab.
        )
        optional true
