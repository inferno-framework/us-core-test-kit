...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class ConditionCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_condition_code_client_search_test
        title 'SHOULD support code search of Condition'
        description %(
          The client demonstrates SHOULD support for searching code on Condition.
        )
        optional true
