...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PatientFamilyClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_patient_family_client_search_test
        title 'SHOULD support family search of Patient'
        description %(
          The client demonstrates SHOULD support for searching family on Patient.
        )
        optional true
