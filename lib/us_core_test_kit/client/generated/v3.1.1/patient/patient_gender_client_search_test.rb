...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PatientGenderClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_patient_gender_client_search_test
        title 'SHOULD support gender search of Patient'
        description %(
          The client demonstrates SHOULD support for searching gender on Patient.
        )
        optional true
