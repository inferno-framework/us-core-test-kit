  ...
  module Client
    module USCoreClientV311
      class PractitionerClientGroup < Inferno::TestGroup
        id :us_core_client_v311_practitioner
        title 'Practitioner'
        description %(
...
* identifier
        ...
        test from: :us_core_v311_practitioner_client_support_test
        test from: :us_core_v311_practitioner_client_read_test
        test from: :us_core_v311_practitioner_name_client_search_test
        test from: :us_core_v311_practitioner_identifier_client_search_test
      end
    end
  end
end
