...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class MedicationRequestStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_medication_request_status_client_search_test
        title 'SHOULD support status search of MedicationRequest'
        description %(
          The client demonstrates SHOULD support for searching status on MedicationRequest.
        )
        optional true
