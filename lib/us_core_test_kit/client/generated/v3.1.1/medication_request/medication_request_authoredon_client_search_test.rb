...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class MedicationRequestAuthoredonClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_medication_request_authoredon_client_search_test
        title 'SHOULD support authoredon search of MedicationRequest'
        description %(
          The client demonstrates SHOULD support for searching authoredon on MedicationRequest.
        )
        optional true
