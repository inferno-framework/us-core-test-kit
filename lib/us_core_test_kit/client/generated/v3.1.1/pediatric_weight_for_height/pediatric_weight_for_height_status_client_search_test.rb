...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PediatricWeightForHeightStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pediatric_weight_for_height_status_client_search_test
        title 'SHOULD support status search of PediatricWeightForHeight'
        description %(
          The client demonstrates SHOULD support for searching status on PediatricWeightForHeight.
        )
        optional true
