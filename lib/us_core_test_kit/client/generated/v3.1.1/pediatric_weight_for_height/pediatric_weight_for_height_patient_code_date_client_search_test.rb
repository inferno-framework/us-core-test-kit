...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PediatricWeightForHeightPatientCodeDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pediatric_weight_for_height_patient_code_date_client_search_test
        title 'SHOULD support patient + code + date search of PediatricWeightForHeight'
        description %(
          The client demonstrates SHOULD support for searching patient + code + date on PediatricWeightForHeight.
        )
        optional true
