...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PediatricWeightForHeightPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pediatric_weight_for_height_patient_code_client_search_test
        title 'SHOULD support patient + code search of PediatricWeightForHeight'
        description %(
          The client demonstrates SHOULD support for searching patient + code on PediatricWeightForHeight.
        )
        optional true
