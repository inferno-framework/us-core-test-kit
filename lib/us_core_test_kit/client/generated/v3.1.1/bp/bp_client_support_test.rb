...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class BpClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v311_bp_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-blood-pressure` for the Observation Blood Pressure Profile.
