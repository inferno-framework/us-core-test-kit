  ...
  module Client
    module USCoreClientV311
      class CareTeamPatientStatusClientSearchTest < Inferno::Test
        ...
        id :us_core_v311_care_team_patient_status_client_search_test
        title 'SHOULD support patient + status search of CareTeam'
        description %(
          The client demonstrates SHOULD support for searching patient + status on CareTeam.
        )
        optional true
