...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class HeartrateClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v311_heartrate_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-heart-rate` for the Observation Heart Rate Profile.
