  ...
  module Client
    module USCoreClientV311
      class EncounterClientGroup < Inferno::TestGroup
        id :us_core_client_v311_encounter
        title 'Encounter'
        description %(
...
* date + patient
        ...
        test from: :us_core_v311_encounter_client_support_test
        test from: :us_core_v311_encounter_client_read_test
        test from: :us_core_v311_encounter_patient_client_search_test
        test from: :us_core_v311_encounter_id_client_search_test
        test from: :us_core_v311_encounter_class_client_search_test
        test from: :us_core_v311_encounter_date_client_search_test
        test from: :us_core_v311_encounter_identifier_client_search_test
        test from: :us_core_v311_encounter_status_client_search_test
        test from: :us_core_v311_encounter_type_client_search_test
        test from: :us_core_v311_encounter_class_patient_client_search_test
        test from: :us_core_v311_encounter_patient_status_client_search_test
        test from: :us_core_v311_encounter_patient_type_client_search_test
        test from: :us_core_v311_encounter_date_patient_client_search_test
      end
    end
  end
end
