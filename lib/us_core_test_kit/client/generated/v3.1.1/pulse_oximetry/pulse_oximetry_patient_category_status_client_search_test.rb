...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PulseOximetryPatientCategoryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pulse_oximetry_patient_category_status_client_search_test
        title 'SHOULD support patient + category + status search of PulseOximetry'
        description %(
          The client demonstrates SHOULD support for searching patient + category + status on PulseOximetry.
        )
        optional true
