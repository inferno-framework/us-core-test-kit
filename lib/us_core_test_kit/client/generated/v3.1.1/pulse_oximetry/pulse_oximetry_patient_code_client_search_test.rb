...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PulseOximetryPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pulse_oximetry_patient_code_client_search_test
        title 'SHOULD support patient + code search of PulseOximetry'
        description %(
          The client demonstrates SHOULD support for searching patient + code on PulseOximetry.
        )
        optional true
