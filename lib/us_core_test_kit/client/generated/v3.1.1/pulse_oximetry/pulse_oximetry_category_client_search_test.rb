...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PulseOximetryCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pulse_oximetry_category_client_search_test
        title 'SHOULD support category search of PulseOximetry'
        description %(
          The client demonstrates SHOULD support for searching category on PulseOximetry.
        )
        optional true
