...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PulseOximetryDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pulse_oximetry_date_client_search_test
        title 'SHOULD support date search of PulseOximetry'
        description %(
          The client demonstrates SHOULD support for searching date on PulseOximetry.
        )
        optional true
