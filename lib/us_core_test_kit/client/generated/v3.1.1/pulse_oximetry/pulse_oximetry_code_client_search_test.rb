...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PulseOximetryCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pulse_oximetry_code_client_search_test
        title 'SHOULD support code search of PulseOximetry'
        description %(
          The client demonstrates SHOULD support for searching code on PulseOximetry.
        )
        optional true
