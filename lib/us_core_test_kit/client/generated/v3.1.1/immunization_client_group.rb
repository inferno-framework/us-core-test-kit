...
require_relative 'immunization/immunization_client_support_test'
require_relative 'immunization/immunization_patient_client_search_test'
require_relative 'immunization/immunization_status_client_search_test'
require_relative 'immunization/immunization_date_client_search_test'
  ...
  module Client
    module USCoreClientV311
      class ImmunizationClientGroup < Inferno::TestGroup
        id :us_core_client_v311_immunization
        title 'Immunization'
        description %(
...
* patient + status
        ...
        test from: :us_core_v311_immunization_client_support_test
        test from: :us_core_v311_immunization_client_read_test
        test from: :us_core_v311_immunization_patient_client_search_test
        test from: :us_core_v311_immunization_status_client_search_test
        test from: :us_core_v311_immunization_date_client_search_test
        test from: :us_core_v311_immunization_patient_date_client_search_test
        test from: :us_core_v311_immunization_patient_status_client_search_test
      end
    end
  end
end
