...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class ResprateClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v311_resprate_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-respiratory-rate` for the Observation Respiratory Rate Profile.
