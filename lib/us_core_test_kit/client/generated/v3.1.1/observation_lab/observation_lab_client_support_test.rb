...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class ObservationLabClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v311_observation_lab_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-lab` for the US Core Laboratory Result Observation Profile.
