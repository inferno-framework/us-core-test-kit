...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class BodyweightClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v311_bodyweight_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-body-weight` for the Observation Body Weight Profile.
