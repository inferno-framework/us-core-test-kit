  ...
  module Client
    module USCoreClientV311
      class BodyweightClientReadTest < Inferno::Test
        ...
        id :us_core_v311_bodyweight_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the Observation Body Weight Profile: `Observation/us-core-client-tests-body-weight`."
        end
