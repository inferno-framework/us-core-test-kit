...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PediatricBmiForAgeCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pediatric_bmi_for_age_code_client_search_test
        title 'SHOULD support code search of PediatricBmiForAge'
        description %(
          The client demonstrates SHOULD support for searching code on PediatricBmiForAge.
        )
        optional true
