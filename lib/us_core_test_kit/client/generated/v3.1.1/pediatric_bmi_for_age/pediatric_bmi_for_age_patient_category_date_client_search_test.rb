  ...
  module Client
    module USCoreClientV311
      class PediatricBmiForAgePatientCategoryDateClientSearchTest < Inferno::Test
        ...
        title 'SHALL support patient + category + date search of PediatricBmiForAge'

        description %(
          The client demonstrates SHALL support for searching patient + category + date on PediatricBmiForAge.
        )
