...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class PediatricBmiForAgeDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_pediatric_bmi_for_age_date_client_search_test
        title 'SHOULD support date search of PediatricBmiForAge'
        description %(
          The client demonstrates SHOULD support for searching date on PediatricBmiForAge.
        )
        optional true
