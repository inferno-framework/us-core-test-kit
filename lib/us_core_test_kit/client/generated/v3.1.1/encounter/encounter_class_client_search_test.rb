...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class EncounterClassClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_encounter_class_client_search_test
        title 'SHOULD support class search of Encounter'
        description %(
          The client demonstrates SHOULD support for searching class on Encounter.
        )
        optional true
