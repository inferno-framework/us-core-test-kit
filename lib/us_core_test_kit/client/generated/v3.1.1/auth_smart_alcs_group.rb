  ...
  module Client
    module USCoreClientV311
      class AuthSMARTConfidentialSymmetricGroup < Inferno::TestGroup
        id :us_core_client_v311_auth_smart_alcs
        ...
        test from: :smart_client_authorization_request_verification,
            id: :us_core_client_v311_authorization_smart_alcs_verification,
            config: { options: { endpoint_suite_id: :us_core_client_v311 } }
        test from: :smart_client_token_request_alcs_verification,
            id: :us_core_client_v311_token_smart_alcs_verification,
            config: { options: { endpoint_suite_id: :us_core_client_v311 } }
