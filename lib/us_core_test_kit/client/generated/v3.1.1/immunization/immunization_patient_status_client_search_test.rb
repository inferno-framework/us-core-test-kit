...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class ImmunizationPatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_immunization_patient_status_client_search_test
        title 'SHOULD support patient + status search of Immunization'
        description %(
          The client demonstrates SHOULD support for searching patient + status on Immunization.
        )
        optional true
