  ...
  module Client
    module USCoreClientV311
      class OrganizationClientGroup < Inferno::TestGroup
        id :us_core_client_v311_organization
        title 'Organization'
        description %(
...
* address
        ...
        test from: :us_core_v311_organization_client_support_test
        test from: :us_core_v311_organization_client_read_test
        test from: :us_core_v311_organization_name_client_search_test
        test from: :us_core_v311_organization_address_client_search_test
      end
    end
  end
end
