...
require_relative 'diagnostic_report_note/diagnostic_report_note_client_support_test'
  ...
  module Client
    module USCoreClientV311
      class DiagnosticReportNoteClientGroup < Inferno::TestGroup
        id :us_core_client_v311_diagnostic_report_note
...
* patient + code
        ...
        test from: :us_core_v311_diagnostic_report_note_client_support_test
        test from: :us_core_v311_diagnostic_report_note_client_read_test
        test from: :us_core_v311_diagnostic_report_note_patient_category_client_search_test
        test from: :us_core_v311_diagnostic_report_note_status_client_search_test
        test from: :us_core_v311_diagnostic_report_note_patient_client_search_test
        test from: :us_core_v311_diagnostic_report_note_category_client_search_test
        test from: :us_core_v311_diagnostic_report_note_code_client_search_test
        test from: :us_core_v311_diagnostic_report_note_date_client_search_test
        test from: :us_core_v311_diagnostic_report_note_patient_category_date_client_search_test
        test from: :us_core_v311_diagnostic_report_note_patient_status_client_search_test
        test from: :us_core_v311_diagnostic_report_note_patient_code_date_client_search_test
        test from: :us_core_v311_diagnostic_report_note_patient_code_client_search_test
      end
    end
  end
end
