...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DiagnosticReportNoteDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_diagnostic_report_note_date_client_search_test
        title 'SHOULD support date search of DiagnosticReportNote'
        description %(
          The client demonstrates SHOULD support for searching date on DiagnosticReportNote.
        )
        optional true
