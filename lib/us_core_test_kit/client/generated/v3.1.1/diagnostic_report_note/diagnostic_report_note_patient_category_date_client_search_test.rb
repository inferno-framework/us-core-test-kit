...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DiagnosticReportNotePatientCategoryDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_diagnostic_report_note_patient_category_date_client_search_test
        title 'SHOULD support patient + category + date search of DiagnosticReportNote'
        description %(
          The client demonstrates SHOULD support for searching patient + category + date on DiagnosticReportNote.
        )
        optional true
