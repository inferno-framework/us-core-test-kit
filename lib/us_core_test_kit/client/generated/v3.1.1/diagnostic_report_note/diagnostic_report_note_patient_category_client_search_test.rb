  ...
  module Client
    module USCoreClientV311
      class DiagnosticReportNotePatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v311_diagnostic_report_note_patient_category_client_search_test
        title 'SHOULD support patient + category search of DiagnosticReportNote'
        description %(
          The client demonstrates SHOULD support for searching patient + category on DiagnosticReportNote.
        )
        optional true
