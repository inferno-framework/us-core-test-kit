...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DiagnosticReportNotePatientCodeDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_diagnostic_report_note_patient_code_date_client_search_test
        title 'SHOULD support patient + code + date search of DiagnosticReportNote'
        description %(
          The client demonstrates SHOULD support for searching patient + code + date on DiagnosticReportNote.
        )
        optional true
