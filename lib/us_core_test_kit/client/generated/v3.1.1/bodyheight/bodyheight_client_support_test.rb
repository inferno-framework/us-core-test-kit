...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class BodyheightClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v311_bodyheight_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-body-height` for the Observation Body Height Profile.
