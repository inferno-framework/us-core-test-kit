...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class HeadCircumferenceCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_head_circumference_code_client_search_test
        title 'SHOULD support code search of HeadCircumference'
        description %(
          The client demonstrates SHOULD support for searching code on HeadCircumference.
        )
        optional true
