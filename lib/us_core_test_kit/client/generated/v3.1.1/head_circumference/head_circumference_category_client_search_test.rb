...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class HeadCircumferenceCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_head_circumference_category_client_search_test
        title 'SHOULD support category search of HeadCircumference'
        description %(
          The client demonstrates SHOULD support for searching category on HeadCircumference.
        )
        optional true
