...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class HeadCircumferenceStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_head_circumference_status_client_search_test
        title 'SHOULD support status search of HeadCircumference'
        description %(
          The client demonstrates SHOULD support for searching status on HeadCircumference.
        )
        optional true
