...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class HeadCircumferencePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_head_circumference_patient_client_search_test
        title 'SHOULD support patient search of HeadCircumference'
        description %(
          The client demonstrates SHOULD support for searching patient on HeadCircumference.
        )
        optional true
