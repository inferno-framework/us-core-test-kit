...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class HeadCircumferencePatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_head_circumference_patient_category_client_search_test
        title 'SHOULD support patient + category search of HeadCircumference'
        description %(
          The client demonstrates SHOULD support for searching patient + category on HeadCircumference.
        )
        optional true
