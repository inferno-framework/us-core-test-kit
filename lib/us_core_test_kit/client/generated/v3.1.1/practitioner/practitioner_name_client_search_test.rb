  ...
  module Client
    module USCoreClientV311
      class PractitionerNameClientSearchTest < Inferno::Test
        ...
        id :us_core_v311_practitioner_name_client_search_test
        title 'SHOULD support name search of Practitioner'
        description %(
          The client demonstrates SHOULD support for searching name on Practitioner.
        )
        optional true
