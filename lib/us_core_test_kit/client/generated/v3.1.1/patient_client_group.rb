  ...
  module Client
    module USCoreClientV311
      class PatientClientGroup < Inferno::TestGroup
        id :us_core_client_v311_patient
        title 'Patient'
        description %(
...
* gender + name
        ...
        test from: :us_core_v311_patient_client_support_test
        test from: :us_core_v311_patient_client_read_test
        test from: :us_core_v311_patient_id_client_search_test
        test from: :us_core_v311_patient_birthdate_client_search_test
        test from: :us_core_v311_patient_family_client_search_test
        test from: :us_core_v311_patient_gender_client_search_test
        test from: :us_core_v311_patient_given_client_search_test
        test from: :us_core_v311_patient_identifier_client_search_test
        test from: :us_core_v311_patient_name_client_search_test
        test from: :us_core_v311_patient_birthdate_family_client_search_test
        test from: :us_core_v311_patient_family_gender_client_search_test
        test from: :us_core_v311_patient_birthdate_name_client_search_test
        test from: :us_core_v311_patient_gender_name_client_search_test
      end
    end
  end
end
