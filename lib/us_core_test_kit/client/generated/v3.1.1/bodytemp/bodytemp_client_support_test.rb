...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class BodytempClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v311_bodytemp_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-body-temperature` for the Observation Body Temperature Profile.
