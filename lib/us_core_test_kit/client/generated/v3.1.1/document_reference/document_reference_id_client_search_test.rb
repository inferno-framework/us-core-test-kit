  ...
  module Client
    module USCoreClientV311
      class DocumentReferenceIdClientSearchTest < Inferno::Test
        ...
        id :us_core_v311_document_reference_id_client_search_test

        title 'SHALL support _id search of DocumentReference'

        description %(
          The client demonstrates SHALL support for searching _id on DocumentReference.
        )
