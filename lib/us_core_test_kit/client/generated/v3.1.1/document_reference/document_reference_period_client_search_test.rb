...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DocumentReferencePeriodClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_document_reference_period_client_search_test
        title 'SHOULD support period search of DocumentReference'
        description %(
          The client demonstrates SHOULD support for searching period on DocumentReference.
        )
        optional true
