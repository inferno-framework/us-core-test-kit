...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DocumentReferenceCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_document_reference_category_client_search_test
        title 'SHOULD support category search of DocumentReference'
        description %(
          The client demonstrates SHOULD support for searching category on DocumentReference.
        )
        optional true
