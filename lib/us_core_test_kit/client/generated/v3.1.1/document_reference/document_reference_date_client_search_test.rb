...
module USCoreTestKit
  module Client
    module USCoreClientV311
      class DocumentReferenceDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v311_document_reference_date_client_search_test
        title 'SHOULD support date search of DocumentReference'
        description %(
          The client demonstrates SHOULD support for searching date on DocumentReference.
        )
        optional true
