  ...
  module Client
    module USCoreClientV610
      class DiagnosticReportLabClientGroup < Inferno::TestGroup
        id :us_core_client_v610_diagnostic_report_lab
...
* patient + status
        ...
        test from: :us_core_v610_diagnostic_report_lab_client_support_test
        test from: :us_core_v610_diagnostic_report_lab_client_read_test
        test from: :us_core_v610_diagnostic_report_lab_patient_category_client_search_test
        test from: :us_core_v610_diagnostic_report_lab_patient_client_search_test
        test from: :us_core_v610_diagnostic_report_lab_patient_code_date_client_search_test
        test from: :us_core_v610_diagnostic_report_lab_patient_status_client_search_test
        test from: :us_core_v610_diagnostic_report_lab_patient_category_date_client_search_test
        test from: :us_core_v610_diagnostic_report_lab_patient_code_client_search_test
      end
    end
  end
end
