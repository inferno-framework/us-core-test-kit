  ...
  module Client
    module USCoreClientV610
      class PediatricBmiForAgePatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_pediatric_bmi_for_age_patient_category_client_search_test
        title 'SHALL support patient + category search of PediatricBmiForAge'
        description %(
          The client demonstrates SHALL support for searching patient + category on PediatricBmiForAge.
        )
        optional false
