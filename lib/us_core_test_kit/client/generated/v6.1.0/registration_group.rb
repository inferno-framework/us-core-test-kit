  ...
  module Client
    module USCoreClientV610
      class RegistrationGroup < Inferno::TestGroup
        ...
        test from: :us_core_client_v610_reg_config_smart_display,
              id: :us_core_client_v610_reg_config_smart_alca_display,
              required_suite_options: {
                client_type: USCoreClientOptions::SMART_APP_LAUNCH_CONFIDENTIAL_ASYMMETRIC
              }
        test from: :us_core_client_v610_reg_config_smart_display,
              id: :us_core_client_v610_reg_config_smart_alcs_display,
              required_suite_options: {
                client_type: USCoreClientOptions::SMART_APP_LAUNCH_CONFIDENTIAL_SYMMETRIC
              }
        test from: :us_core_client_v610_reg_config_smart_display,
              id: :us_core_client_v610_reg_config_smart_alp_display,
              required_suite_options: {
                client_type: USCoreClientOptions::SMART_APP_LAUNCH_PUBLIC
              }
        ...
        test from: :udap_client_registration_interaction,
            id: :us_core_client_v610_reg_udap_interaction,
            config: { options: { endpoint_suite_id: :us_core_client_v610 } },
            required_suite_options: {
              client_type: USCoreClientOptions::UDAP_AUTHORIZATION_CODE
            }
        test from: :udap_client_registration_ac_verification,
            id: :us_core_client_v610_reg_udap_verification,
            config: { options: { endpoint_suite_id: :us_core_client_v610 } },
            required_suite_options: {
              client_type: USCoreClientOptions::UDAP_AUTHORIZATION_CODE
            }
        test from: :us_core_client_v610_reg_config_udap_display,
              required_suite_options: {
                client_type: USCoreClientOptions::UDAP_AUTHORIZATION_CODE
              }
      end
