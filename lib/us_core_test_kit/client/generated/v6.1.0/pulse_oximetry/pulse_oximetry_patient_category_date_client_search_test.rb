  ...
  module Client
    module USCoreClientV610
      class PulseOximetryPatientCategoryDateClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_pulse_oximetry_patient_category_date_client_search_test

        title 'SHALL support patient + category + date search of PulseOximetry'

        description %(
          The client demonstrates SHALL support for searching patient + category + date on PulseOximetry.
        )
