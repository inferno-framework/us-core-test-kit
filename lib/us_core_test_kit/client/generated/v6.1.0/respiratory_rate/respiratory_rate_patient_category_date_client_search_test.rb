  ...
  module Client
    module USCoreClientV610
      class RespiratoryRatePatientCategoryDateClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_respiratory_rate_patient_category_date_client_search_test

        title 'SHALL support patient + category + date search of RespiratoryRate'

        description %(
          The client demonstrates SHALL support for searching patient + category + date on RespiratoryRate.
        )
