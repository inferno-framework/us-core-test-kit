  ...
  module Client
    module USCoreClientV610
      class DiagnosticReportNotePatientClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_diagnostic_report_note_patient_client_search_test

        title 'SHALL support patient search of DiagnosticReportNote'

        description %(
          The client demonstrates SHALL support for searching patient on DiagnosticReportNote.
        )
