  ...
  module Client
    module USCoreClientV610
      class DiagnosticReportNoteClientReadTest < Inferno::Test
        ...
        id :us_core_v610_diagnostic_report_note_client_read_test
        ...
        def failure_message
          "Did not receive a request for `DiagnosticReport` with id: `us-core-client-tests-diagnostic-report-note`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests_of_type, 'us-core-client-tests-diagnostic-report-note')
