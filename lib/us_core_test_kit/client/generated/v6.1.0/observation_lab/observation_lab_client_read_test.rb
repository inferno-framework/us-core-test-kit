  ...
  module Client
    module USCoreClientV610
      class ObservationLabClientReadTest < Inferno::Test
        ...
        id :us_core_v610_observation_lab_client_read_test
        ...
        def failure_message
          "Did not receive a request for `Observation` with id: `us-core-client-tests-observation-lab`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests_of_type, 'us-core-client-tests-observation-lab')
