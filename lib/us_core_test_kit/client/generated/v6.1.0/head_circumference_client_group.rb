  ...
  module Client
    module USCoreClientV610
      class HeadCircumferenceClientGroup < Inferno::TestGroup
        id :us_core_client_v610_head_circumference
...
* patient + category + status
        ...
        test from: :us_core_v610_head_circumference_client_support_test
        test from: :us_core_v610_head_circumference_client_read_test
        test from: :us_core_v610_head_circumference_patient_code_client_search_test
        test from: :us_core_v610_head_circumference_patient_code_date_client_search_test
        test from: :us_core_v610_head_circumference_patient_category_status_client_search_test
        test from: :us_core_v610_head_circumference_patient_category_date_client_search_test
        test from: :us_core_v610_head_circumference_patient_category_client_search_test
      end
    end
  end
end
