  ...
  module Client
    module USCoreClientV610
      class HeadCircumferencePatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_head_circumference_patient_category_client_search_test
        title 'SHALL support patient + category search of HeadCircumference'
        description %(
          The client demonstrates SHALL support for searching patient + category on HeadCircumference.
        )
        optional false
