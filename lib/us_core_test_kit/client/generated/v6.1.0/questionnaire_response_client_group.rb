...
* patient + status
        ...
        test from: :us_core_v610_questionnaire_response_client_support_test
        ...
        test from: :us_core_v610_questionnaire_response_patient_questionnaire_client_search_test
        test from: :us_core_v610_questionnaire_response_patient_authored_client_search_test
        test from: :us_core_v610_questionnaire_response_patient_status_client_search_test
      end
    end
  end
end
