...
* patient + status
        ...
        test from: :us_core_v610_device_client_support_test
        test from: :us_core_v610_device_client_read_test
        test from: :us_core_v610_device_patient_client_search_test
        test from: :us_core_v610_device_patient_type_client_search_test
        test from: :us_core_v610_device_patient_status_client_search_test
      end
    end
  end
end
