...
require_relative 'service_request/service_request_client_support_test'
  ...
  module Client
    module USCoreClientV610
      class ServiceRequestClientGroup < Inferno::TestGroup
        id :us_core_client_v610_service_request
...
* patient + code + authored
        ...
        test from: :us_core_v610_service_request_client_support_test
        test from: :us_core_v610_service_request_client_read_test
        test from: :us_core_v610_service_request_patient_client_search_test
        test from: :us_core_v610_service_request_id_client_search_test
        test from: :us_core_v610_service_request_patient_category_authored_client_search_test
        test from: :us_core_v610_service_request_patient_status_client_search_test
        test from: :us_core_v610_service_request_patient_category_client_search_test
        test from: :us_core_v610_service_request_patient_code_authored_client_search_test
        test from: :us_core_v610_service_request_patient_code_client_search_test
      end
    end
  end
end
