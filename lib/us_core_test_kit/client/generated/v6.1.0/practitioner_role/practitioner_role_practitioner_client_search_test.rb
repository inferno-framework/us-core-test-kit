  ...
  module Client
    module USCoreClientV610
      class PractitionerRolePractitionerClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_practitioner_role_practitioner_client_search_test
        ...
        def failure_message
          "Did not receive a request for `PractitionerRole` with required search parameters: `#{required_params.join(' + ')}`"
        end
