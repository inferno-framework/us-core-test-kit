...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class ObservationPregnancystatusClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v610_observation_pregnancystatus_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-pregnancystatus` for the US Core Observation Pregnancy Status Profile.
