...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class ConditionProblemsHealthConcernsPatientClinicalStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v610_condition_problems_health_concerns_patient_clinical_status_client_search_test
        title 'SHOULD support patient + clinical-status search of ConditionProblemsHealthConcerns'
        description %(
          The client demonstrates SHOULD support for searching patient + clinical-status on ConditionProblemsHealthConcerns.
        )
        optional true
