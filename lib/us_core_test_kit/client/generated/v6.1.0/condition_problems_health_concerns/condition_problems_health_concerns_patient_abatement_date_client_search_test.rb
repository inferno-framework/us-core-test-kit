...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class ConditionProblemsHealthConcernsPatientAbatementDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v610_condition_problems_health_concerns_patient_abatement_date_client_search_test
        title 'SHOULD support patient + abatement-date search of ConditionProblemsHealthConcerns'
        description %(
          The client demonstrates SHOULD support for searching patient + abatement-date on ConditionProblemsHealthConcerns.
        )
        optional true
