  ...
  module Client
    module USCoreClientV610
      class PatientClientGroup < Inferno::TestGroup
        id :us_core_client_v610_patient
        title 'Patient'
        description %(
...
* death-date + family
        ...
        test from: :us_core_v610_patient_client_support_test
        test from: :us_core_v610_patient_client_read_test
        test from: :us_core_v610_patient_id_client_search_test
        test from: :us_core_v610_patient_identifier_client_search_test
        test from: :us_core_v610_patient_name_client_search_test
        test from: :us_core_v610_patient_birthdate_family_client_search_test
        test from: :us_core_v610_patient_family_gender_client_search_test
        test from: :us_core_v610_patient_birthdate_name_client_search_test
        test from: :us_core_v610_patient_gender_name_client_search_test
        test from: :us_core_v610_patient_death_date_family_client_search_test
      end
    end
  end
end
