...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class ObservationOccupationPatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v610_observation_occupation_patient_category_client_search_test
        title 'SHALL support patient + category search of ObservationOccupation'
        description %(
          The client demonstrates SHALL support for searching patient + category on ObservationOccupation.
        )
        optional false
