...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class ObservationOccupationPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v610_observation_occupation_patient_code_client_search_test

        title 'SHALL support patient + code search of ObservationOccupation'

        description %(
          The client demonstrates SHALL support for searching patient + code on ObservationOccupation.
        )
