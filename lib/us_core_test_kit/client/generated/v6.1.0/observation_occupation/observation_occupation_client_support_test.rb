...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class ObservationOccupationClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v610_observation_occupation_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-occupation` for the US Core Observation Occupation Profile.
