  ...
  module Client
    module USCoreClientV610
      class BodyWeightPatientCategoryDateClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_body_weight_patient_category_date_client_search_test

        title 'SHALL support patient + category + date search of BodyWeight'

        description %(
          The client demonstrates SHALL support for searching patient + category + date on BodyWeight.
        )
