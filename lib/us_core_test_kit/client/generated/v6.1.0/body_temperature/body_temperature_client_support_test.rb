...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class BodyTemperatureClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v610_body_temperature_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-body-temperature` for the US Core Body Temperature Profile.
