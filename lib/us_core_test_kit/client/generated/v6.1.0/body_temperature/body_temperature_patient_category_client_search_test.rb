  ...
  module Client
    module USCoreClientV610
      class BodyTemperaturePatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_body_temperature_patient_category_client_search_test
        title 'SHALL support patient + category search of BodyTemperature'
        description %(
          The client demonstrates SHALL support for searching patient + category on BodyTemperature.
        )
        optional false
