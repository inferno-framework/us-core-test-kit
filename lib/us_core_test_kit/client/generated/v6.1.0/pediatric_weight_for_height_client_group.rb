  ...
  module Client
    module USCoreClientV610
      class PediatricWeightForHeightClientGroup < Inferno::TestGroup
        id :us_core_client_v610_pediatric_weight_for_height
...
* patient + category + status
        ...
        test from: :us_core_v610_pediatric_weight_for_height_client_support_test
        test from: :us_core_v610_pediatric_weight_for_height_client_read_test
        test from: :us_core_v610_pediatric_weight_for_height_patient_code_client_search_test
        test from: :us_core_v610_pediatric_weight_for_height_patient_code_date_client_search_test
        test from: :us_core_v610_pediatric_weight_for_height_patient_category_status_client_search_test
        test from: :us_core_v610_pediatric_weight_for_height_patient_category_date_client_search_test
        test from: :us_core_v610_pediatric_weight_for_height_patient_category_client_search_test
      end
    end
  end
end
