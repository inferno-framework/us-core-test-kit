  ...
  module Client
    module USCoreClientV610
      class PractitionerClientGroup < Inferno::TestGroup
        id :us_core_client_v610_practitioner
        title 'Practitioner'
        description %(
...
* _id
        ...
        test from: :us_core_v610_practitioner_client_support_test
        test from: :us_core_v610_practitioner_client_read_test
        test from: :us_core_v610_practitioner_id_client_search_test
        test from: :us_core_v610_practitioner_name_client_search_test
        test from: :us_core_v610_practitioner_identifier_client_search_test
      end
    end
  end
end
