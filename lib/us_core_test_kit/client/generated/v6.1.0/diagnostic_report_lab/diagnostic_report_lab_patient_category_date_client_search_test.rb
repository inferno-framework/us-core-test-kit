  ...
  module Client
    module USCoreClientV610
      class DiagnosticReportLabPatientCategoryDateClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_diagnostic_report_lab_patient_category_date_client_search_test
        title 'SHALL support patient + category + date search of DiagnosticReportLab'
        description %(
          The client demonstrates SHALL support for searching patient + category + date on DiagnosticReportLab.
        )
        optional false
