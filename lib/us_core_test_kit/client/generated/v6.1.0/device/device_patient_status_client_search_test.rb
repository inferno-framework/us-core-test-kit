...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class DevicePatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v610_device_patient_status_client_search_test
        title 'SHOULD support patient + status search of Device'
        description %(
          The client demonstrates SHOULD support for searching patient + status on Device.
        )
        optional true
