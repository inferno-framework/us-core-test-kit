...
module USCoreTestKit
  module Client
    module USCoreClientV610
      class ServiceRequestPatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v610_service_request_patient_status_client_search_test
        title 'SHOULD support patient + status search of ServiceRequest'
        description %(
          The client demonstrates SHOULD support for searching patient + status on ServiceRequest.
        )
        optional true
