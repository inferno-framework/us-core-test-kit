  ...
  module Client
    module USCoreClientV610
      class ServiceRequestPatientCategoryAuthoredClientSearchTest < Inferno::Test
        ...
        id :us_core_v610_service_request_patient_category_authored_client_search_test
        ...
        def failure_message
          "Did not recieve a request for `ServiceRequest` with required search parameters: `#{required_params.join(' + ')}`"
        end
