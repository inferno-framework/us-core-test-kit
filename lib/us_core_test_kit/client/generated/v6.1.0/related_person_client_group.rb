...
require_relative 'related_person/related_person_client_support_test'
  ...
  module Client
    module USCoreClientV610
      class RelatedPersonClientGroup < Inferno::TestGroup
        id :us_core_client_v610_related_person
        title 'RelatedPerson'
        description %(
...
* patient + name
        ...
        test from: :us_core_v610_related_person_client_support_test
        test from: :us_core_v610_related_person_client_read_test
        test from: :us_core_v610_related_person_patient_client_search_test
        test from: :us_core_v610_related_person_id_client_search_test
        test from: :us_core_v610_related_person_name_client_search_test
        test from: :us_core_v610_related_person_patient_name_client_search_test
      end
    end
  end
end
