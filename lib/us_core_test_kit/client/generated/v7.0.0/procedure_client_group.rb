  ...
  module Client
    module USCoreClientV700
      class ProcedureClientGroup < Inferno::TestGroup
        id :us_core_client_v700_procedure
        title 'Procedure'
        description %(
...
* patient + status
        ...
        test from: :us_core_v700_procedure_client_support_test
        test from: :us_core_v700_procedure_client_read_test
        test from: :us_core_v700_procedure_patient_client_search_test
        test from: :us_core_v700_procedure_patient_code_date_client_search_test
        test from: :us_core_v700_procedure_patient_date_client_search_test
        test from: :us_core_v700_procedure_patient_status_client_search_test
      end
    end
  end
end
