...
* patient + discharge-disposition
        ...
        test from: :us_core_v700_encounter_client_support_test
        ...
        test from: :us_core_v700_encounter_identifier_client_search_test
        test from: :us_core_v700_encounter_date_patient_client_search_test
        test from: :us_core_v700_encounter_class_patient_client_search_test
        test from: :us_core_v700_encounter_patient_type_client_search_test
        test from: :us_core_v700_encounter_patient_lastupdated_client_search_test
        test from: :us_core_v700_encounter_patient_status_client_search_test
        test from: :us_core_v700_encounter_patient_location_client_search_test
        test from: :us_core_v700_encounter_patient_discharge_disposition_client_search_test
      end
    end
  end
end
