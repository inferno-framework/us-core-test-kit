  ...
  module Client
    module USCoreClientV700
      class QuestionnaireResponseClientGroup < Inferno::TestGroup
        id :us_core_client_v700_questionnaire_response
...
* patient + status
        ...
        test from: :us_core_v700_questionnaire_response_client_support_test
        test from: :us_core_v700_questionnaire_response_client_read_test
        test from: :us_core_v700_questionnaire_response_patient_client_search_test
        test from: :us_core_v700_questionnaire_response_id_client_search_test
        test from: :us_core_v700_questionnaire_response_patient_questionnaire_client_search_test
        test from: :us_core_v700_questionnaire_response_patient_authored_client_search_test
        test from: :us_core_v700_questionnaire_response_patient_status_client_search_test
      end
    end
  end
end
