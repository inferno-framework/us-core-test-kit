...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class CareExperiencePreferenceClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_care_experience_preference_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-care-experience-preference` for the US Core Care Experience Preference Profile.
