...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class LocationAddressCityClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_location_address_city_client_search_test
        title 'SHOULD support address-city search of Location'
        description %(
          The client demonstrates SHOULD support for searching address-city on Location.
        )
        optional true
