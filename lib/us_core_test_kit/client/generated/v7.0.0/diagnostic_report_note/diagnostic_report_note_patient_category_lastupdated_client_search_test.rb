...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class DiagnosticReportNotePatientCategoryLastupdatedClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_diagnostic_report_note_patient_category_lastupdated_client_search_test
        title 'SHOULD support patient + category + _lastUpdated search of DiagnosticReportNote'
        description %(
          The client demonstrates SHOULD support for searching patient + category + _lastUpdated on DiagnosticReportNote.
        )
        optional true
