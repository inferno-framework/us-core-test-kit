...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class ObservationSexualOrientationClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_observation_sexual_orientation_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-sexual-orientation` for the US Core Observation Sexual Orientation Profile.
