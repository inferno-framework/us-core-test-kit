  ...
  module Client
    module USCoreClientV700
      class CarePlanPatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v700_care_plan_patient_category_client_search_test
        ...
        def failure_message
          "Did not receive a request for `CarePlan` with required search parameters: `#{required_params.join(' + ')}`"
        end
