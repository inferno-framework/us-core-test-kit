...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class GoalPatientTargetDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_goal_patient_target_date_client_search_test
        title 'SHOULD support patient + target-date search of Goal'
        description %(
          The client demonstrates SHOULD support for searching patient + target-date on Goal.
        )
        optional true
