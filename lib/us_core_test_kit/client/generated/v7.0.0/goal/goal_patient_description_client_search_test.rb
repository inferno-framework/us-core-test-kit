...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class GoalPatientDescriptionClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_goal_patient_description_client_search_test
        title 'SHOULD support patient + description search of Goal'
        description %(
          The client demonstrates SHOULD support for searching patient + description on Goal.
        )
        optional true
