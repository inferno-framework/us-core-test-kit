...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class EncounterPatientLastupdatedClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_encounter_patient_lastupdated_client_search_test
        title 'SHOULD support patient + _lastUpdated search of Encounter'
        description %(
          The client demonstrates SHOULD support for searching patient + _lastUpdated on Encounter.
        )
        optional true
