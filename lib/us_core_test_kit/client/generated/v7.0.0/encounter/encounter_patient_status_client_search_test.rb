...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class EncounterPatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_encounter_patient_status_client_search_test
        title 'SHOULD support patient + status search of Encounter'
        description %(
          The client demonstrates SHOULD support for searching patient + status on Encounter.
        )
        optional true
