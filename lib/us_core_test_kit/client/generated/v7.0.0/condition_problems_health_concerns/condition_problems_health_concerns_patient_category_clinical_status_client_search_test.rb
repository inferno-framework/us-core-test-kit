...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class ConditionProblemsHealthConcernsPatientCategoryClinicalStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_condition_problems_health_concerns_patient_category_clinical_status_client_search_test
        title 'SHOULD support patient + category + clinical-status search of ConditionProblemsHealthConcerns'
        description %(
          The client demonstrates SHOULD support for searching patient + category + clinical-status on ConditionProblemsHealthConcerns.
        )
        optional true
