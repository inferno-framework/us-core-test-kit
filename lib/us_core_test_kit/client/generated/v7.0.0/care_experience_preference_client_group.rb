...
require_relative 'care_experience_preference/care_experience_preference_client_support_test'
...
* patient + category + _lastUpdated
        ...
        test from: :us_core_v700_care_experience_preference_client_support_test
