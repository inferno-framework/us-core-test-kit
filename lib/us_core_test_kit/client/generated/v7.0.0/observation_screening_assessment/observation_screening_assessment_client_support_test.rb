...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class ObservationScreeningAssessmentClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_observation_screening_assessment_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-screening-assessment` for the US Core Observation Screening Assessment Profile.
