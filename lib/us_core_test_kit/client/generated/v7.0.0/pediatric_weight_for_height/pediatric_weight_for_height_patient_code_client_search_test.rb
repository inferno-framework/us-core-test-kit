  ...
  module Client
    module USCoreClientV700
      class PediatricWeightForHeightPatientCodeClientSearchTest < Inferno::Test
        ...
        id :us_core_v700_pediatric_weight_for_height_patient_code_client_search_test

        title 'SHALL support patient + code search of PediatricWeightForHeight'

        description %(
          The client demonstrates SHALL support for searching patient + code on PediatricWeightForHeight.
        )
