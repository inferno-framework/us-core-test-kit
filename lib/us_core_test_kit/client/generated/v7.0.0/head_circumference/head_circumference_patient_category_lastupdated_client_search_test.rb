...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class HeadCircumferencePatientCategoryLastupdatedClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_head_circumference_patient_category_lastupdated_client_search_test
        title 'SHOULD support patient + category + _lastUpdated search of HeadCircumference'
        description %(
          The client demonstrates SHOULD support for searching patient + category + _lastUpdated on HeadCircumference.
        )
        optional true
