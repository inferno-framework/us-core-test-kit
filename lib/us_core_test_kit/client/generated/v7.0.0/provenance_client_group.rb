...
require_relative 'provenance/provenance_client_support_test'

module USCoreTestKit
  module Client
    module USCoreClientV700
      class ProvenanceClientGroup < Inferno::TestGroup
        id :us_core_client_v700_provenance
        title 'Provenance'
        description %(
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_core_v700_provenance_client_support_test
        test from: :us_core_v700_provenance_client_read_test
      end
    end
  end
end
