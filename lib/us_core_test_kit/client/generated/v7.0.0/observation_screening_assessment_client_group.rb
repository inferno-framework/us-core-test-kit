...
* patient + category + _lastUpdated
        ...
        test from: :us_core_v700_observation_screening_assessment_client_support_test
        ...
        test from: :us_core_v700_observation_screening_assessment_patient_code_date_client_search_test
        test from: :us_core_v700_observation_screening_assessment_patient_category_status_client_search_test
        test from: :us_core_v700_observation_screening_assessment_patient_category_lastupdated_client_search_test
      end
    end
  end
end
