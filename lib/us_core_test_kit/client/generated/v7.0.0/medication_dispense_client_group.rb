...
require_relative 'medication_dispense/medication_dispense_client_support_test'
  ...
  module Client
    module USCoreClientV700
      class MedicationDispenseClientGroup < Inferno::TestGroup
        id :us_core_client_v700_medication_dispense
...
* patient + status
        ...
        test from: :us_core_v700_medication_dispense_client_support_test
        test from: :us_core_v700_medication_dispense_client_read_test
        test from: :us_core_v700_medication_dispense_patient_client_search_test
        test from: :us_core_v700_medication_dispense_patient_status_type_client_search_test
        test from: :us_core_v700_medication_dispense_patient_status_client_search_test
      end
    end
  end
end
