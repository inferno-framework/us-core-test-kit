  ...
  module Client
    module USCoreClientV700
      class MedicationRequestClientGroup < Inferno::TestGroup
        id :us_core_client_v700_medication_request
...
* patient + intent + authoredon
        ...
        test from: :us_core_v700_medication_request_client_support_test
        test from: :us_core_v700_medication_request_client_read_test
        test from: :us_core_v700_medication_request_patient_intent_client_search_test
        test from: :us_core_v700_medication_request_patient_intent_encounter_client_search_test
        test from: :us_core_v700_medication_request_patient_intent_authoredon_client_search_test
        test from: :us_core_v700_medication_request_patient_intent_status_client_search_test
      end
    end
  end
end
