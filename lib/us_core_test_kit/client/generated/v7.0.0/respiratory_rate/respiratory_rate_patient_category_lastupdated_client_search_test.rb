...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class RespiratoryRatePatientCategoryLastupdatedClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_respiratory_rate_patient_category_lastupdated_client_search_test
        title 'SHOULD support patient + category + _lastUpdated search of RespiratoryRate'
        description %(
          The client demonstrates SHOULD support for searching patient + category + _lastUpdated on RespiratoryRate.
        )
        optional true
