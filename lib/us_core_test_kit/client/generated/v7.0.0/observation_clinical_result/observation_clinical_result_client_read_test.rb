  ...
  module Client
    module USCoreClientV700
      class ObservationClinicalResultClientReadTest < Inferno::Test
        ...
        id :us_core_v700_observation_clinical_result_client_read_test
        ...
        def failure_message
          "Did not receive a request for `Observation` with id: `us-core-client-tests-observation-clinical-result`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests_of_type, 'us-core-client-tests-observation-clinical-result')
