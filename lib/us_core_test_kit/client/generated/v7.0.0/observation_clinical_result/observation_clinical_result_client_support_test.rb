...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class ObservationClinicalResultClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_observation_clinical_result_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-clinical-result` for the US Core Observation Clinical Result Profile.
