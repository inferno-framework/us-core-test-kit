...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class ObservationPregnancyintentClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_observation_pregnancyintent_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-pregnancyintent` for the US Core Observation Pregnancy Intent Profile.
