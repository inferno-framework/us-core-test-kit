...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class ConditionEncounterDiagnosisPatientLastupdatedClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_condition_encounter_diagnosis_patient_lastupdated_client_search_test
        title 'SHOULD support patient + _lastUpdated search of ConditionEncounterDiagnosis'
        description %(
          The client demonstrates SHOULD support for searching patient + _lastUpdated on ConditionEncounterDiagnosis.
        )
        optional true
