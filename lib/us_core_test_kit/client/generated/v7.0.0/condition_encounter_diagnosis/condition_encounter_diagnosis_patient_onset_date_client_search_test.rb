...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class ConditionEncounterDiagnosisPatientOnsetDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_condition_encounter_diagnosis_patient_onset_date_client_search_test
        title 'SHOULD support patient + onset-date search of ConditionEncounterDiagnosis'
        description %(
          The client demonstrates SHOULD support for searching patient + onset-date on ConditionEncounterDiagnosis.
        )
        optional true
