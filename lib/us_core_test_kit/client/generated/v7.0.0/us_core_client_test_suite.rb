...
require_relative 'treatment_intervention_preference_client_group'
require_relative 'care_experience_preference_client_group'
...
require_relative 'average_blood_pressure_client_group'
  ...
  module Client
    module USCoreClientV700
      class USCoreClientTestSuite < Inferno::TestSuite
        ...
        title 'US Core Client v7.0.0'
        description %(
          
The US Core Test Kit Client Suite tests client systems for their conformance
to the [US Core Implementation Guide](http://hl7.org/fhir/us/core/STU7).
...
* **[US Core Patient Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-patient|7.0.0)** (id: us-core-client-tests-patient)
* **[US Core AllergyIntolerance Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-allergyintolerance|7.0.0)** (id: us-core-client-tests-allergy-intolerance)
* **[US Core CarePlan Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-careplan|7.0.0)** (id: us-core-client-tests-care-plan)
* **[US Core CareTeam Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-careteam|7.0.0)** (id: us-core-client-tests-care-team)
* **[US Core Condition Encounter Diagnosis Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-condition-encounter-diagnosis|7.0.0)** (id: us-core-client-tests-condition-encounter-diagnosis)
* **[US Core Condition Problems and Health Concerns Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-condition-problems-health-concerns|7.0.0)** (id: us-core-client-tests-condition-problems-health-concerns)
* **[US Core Coverage Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-coverage|7.0.0)** (id: us-core-client-tests-coverage)
* **[US Core Implantable Device Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-implantable-device|7.0.0)** (id: us-core-client-tests-device)
* **[US Core DiagnosticReport Profile for Report and Note Exchange](http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-note|7.0.0)** (id: us-core-client-tests-diagnostic-report-note)
* **[US Core DiagnosticReport Profile for Laboratory Results Reporting](http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab|7.0.0)** (id: us-core-client-tests-diagnostic-report-lab)
* **[US Core DocumentReference Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-documentreference|7.0.0)** (id: us-core-client-tests-document-reference)
* **[US Core Encounter Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-encounter|7.0.0)** (id: us-core-client-tests-encounter)
* **[US Core Goal Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-goal|7.0.0)** (id: us-core-client-tests-goal)
* **[US Core Immunization Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-immunization|7.0.0)** (id: us-core-client-tests-immunization)
* **[US Core MedicationDispense Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationdispense|7.0.0)** (id: us-core-client-tests-medication-dispense)
* **[US Core MedicationRequest Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationrequest|7.0.0)** (id: us-core-client-tests-medication-request)
* **[US Core Laboratory Result Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-lab|7.0.0)** (id: us-core-client-tests-observation-lab)
* **[US Core Observation Pregnancy Status Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-pregnancystatus|7.0.0)** (id: us-core-client-tests-observation-pregnancystatus)
* **[US Core Observation Pregnancy Intent Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-pregnancyintent|7.0.0)** (id: us-core-client-tests-observation-pregnancyintent)
* **[US Core Observation Occupation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-occupation|7.0.0)** (id: us-core-client-tests-observation-occupation)
* **[US Core Respiratory Rate Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-respiratory-rate|7.0.0)** (id: us-core-client-tests-respiratory-rate)
* **[US Core Simple Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-simple-observation|7.0.0)** (id: us-core-client-tests-simple-observation)
* **[US Core Treatment Intervention Preference Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-treatment-intervention-preference|7.0.0)** (id: us-core-client-tests-treatment-intervention-preference)
* **[US Core Care Experience Preference Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-care-experience-preference|7.0.0)** (id: us-core-client-tests-care-experience-preference)
* **[US Core Heart Rate Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-heart-rate|7.0.0)** (id: us-core-client-tests-heart-rate)
* **[US Core Body Temperature Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-temperature|7.0.0)** (id: us-core-client-tests-body-temperature)
* **[US Core Pediatric Weight for Height Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height|7.0.0)** (id: us-core-client-tests-pediatric-weight-for-height)
* **[US Core Pulse Oximetry Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry|7.0.0)** (id: us-core-client-tests-pulse-oximetry)
* **[US Core Smoking Status Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-smokingstatus|7.0.0)** (id: us-core-client-tests-smokingstatus)
* **[US Core Observation Sexual Orientation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-sexual-orientation|7.0.0)** (id: us-core-client-tests-observation-sexual-orientation)
* **[US Core Head Circumference Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-head-circumference|7.0.0)** (id: us-core-client-tests-head-circumference-percentile)
* **[US Core Body Height Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-height|7.0.0)** (id: us-core-client-tests-body-height)
* **[US Core BMI Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi|7.0.0)** (id: us-core-client-tests-bmi)
* **[US Core Observation Screening Assessment Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-screening-assessment|7.0.0)** (id: us-core-client-tests-observation-screening-assessment)
* **[US Core Average Blood Pressure Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-average-blood-pressure|7.0.0)** (id: us-core-client-tests-average-blood-pressure)
* **[US Core Blood Pressure Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-blood-pressure|7.0.0)** (id: us-core-client-tests-blood-pressure)
* **[US Core Observation Clinical Result Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-clinical-result|7.0.0)** (id: us-core-client-tests-observation-clinical-result)
* **[US Core Pediatric BMI for Age Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/pediatric-bmi-for-age|7.0.0)** (id: us-core-client-tests-pediatric-bmi-for-age)
* **[US Core Pediatric Head Occipital Frontal Circumference Percentile Profile](http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile|7.0.0)** (id: us-core-client-tests-head-circumference-percentile)
* **[US Core Body Weight Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-weight|7.0.0)** (id: us-core-client-tests-body-weight)
* **[US Core Procedure Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-procedure|7.0.0)** (id: us-core-client-tests-procedure)
* **[US Core QuestionnaireResponse Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-questionnaireresponse|7.0.0)** (id: us-core-client-tests-questionnaire-response)
* **[US Core ServiceRequest Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-servicerequest|7.0.0)** (id: us-core-client-tests-service-request)
* **[US Core Location Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-location|7.0.0)** (id: us-core-client-tests-location)
* **[US Core Organization Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-organization|7.0.0)** (id: us-core-client-tests-organization)
* **[US Core Practitioner Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitioner|7.0.0)** (id: us-core-client-tests-practitioner)
* **[US Core PractitionerRole Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitionerrole|7.0.0)** (id: us-core-client-tests-practitioner-role)
* **[US Core Provenance Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-provenance|7.0.0)** (id: us-core-client-tests-provenance)
* **[US Core RelatedPerson Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-relatedperson|7.0.0)** (id: us-core-client-tests-related-person)
* **[US Core Specimen Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-specimen|7.0.0)** (id: us-core-client-tests-specimen)
...
- Testing a client's ability to perform read requests against a FHIR server for all US Core Profiles
  listed in the [US Core Client CapabilityStatement](http://hl7.org/fhir/us/core/STU7/CapabilityStatement-us-core-client.html).
- Testing a client's ability to perform searches using search parameters and combinations
  listed for each resource type in the [US Core Client CapabilityStatement](http://hl7.org/fhir/us/core/STU7/CapabilityStatement-us-core-client.html).
...
- Check the Must Support Conformance Requirements for clients/requestors specified in US Core IG v7.0.0
...
- Allow testers to bring their own data. Testers must manually configure their client system to connect
  to a specific target patient and must access and process specific curated sample US Core data.
        ...
        group do
          id :us_core_client_read_search_group_v700
          title 'Read & Search'
          description %(
            
During these tests, the US Core client system will interact with Inferno's simulated US Core Server
and demonstrate its ability to perform the FHIR interactions described in the [US Core Client CapabilityStatement](http://hl7.org/fhir/us/core/STU7/CapabilityStatement-us-core-client.html).


          )

          group from: :us_core_client_access_group_v700

          group from: :us_core_client_v700_patient
          group from: :us_core_client_v700_allergy_intolerance
          group from: :us_core_client_v700_care_plan
          group from: :us_core_client_v700_care_team
          group from: :us_core_client_v700_condition_encounter_diagnosis
          group from: :us_core_client_v700_condition_problems_health_concerns
          group from: :us_core_client_v700_coverage
          group from: :us_core_client_v700_device
          group from: :us_core_client_v700_diagnostic_report_note
          group from: :us_core_client_v700_diagnostic_report_lab
          group from: :us_core_client_v700_document_reference
          group from: :us_core_client_v700_encounter
          group from: :us_core_client_v700_goal
          group from: :us_core_client_v700_immunization
          group from: :us_core_client_v700_medication_dispense
          group from: :us_core_client_v700_medication_request
          group from: :us_core_client_v700_observation_lab
          group from: :us_core_client_v700_observation_pregnancystatus
          group from: :us_core_client_v700_observation_pregnancyintent
          group from: :us_core_client_v700_observation_occupation
          group from: :us_core_client_v700_respiratory_rate
          group from: :us_core_client_v700_simple_observation
          group from: :us_core_client_v700_treatment_intervention_preference
          group from: :us_core_client_v700_care_experience_preference
          group from: :us_core_client_v700_heart_rate
          group from: :us_core_client_v700_body_temperature
          group from: :us_core_client_v700_pediatric_weight_for_height
          group from: :us_core_client_v700_pulse_oximetry
          group from: :us_core_client_v700_smokingstatus
          group from: :us_core_client_v700_observation_sexual_orientation
          group from: :us_core_client_v700_head_circumference
          group from: :us_core_client_v700_body_height
          group from: :us_core_client_v700_bmi
          group from: :us_core_client_v700_observation_screening_assessment
          group from: :us_core_client_v700_average_blood_pressure
          group from: :us_core_client_v700_blood_pressure
          group from: :us_core_client_v700_observation_clinical_result
          group from: :us_core_client_v700_pediatric_bmi_for_age
          group from: :us_core_client_v700_head_circumference_percentile
          group from: :us_core_client_v700_body_weight
          group from: :us_core_client_v700_procedure
          group from: :us_core_client_v700_questionnaire_response
          group from: :us_core_client_v700_service_request
          group from: :us_core_client_v700_location
          group from: :us_core_client_v700_organization
          group from: :us_core_client_v700_practitioner
          group from: :us_core_client_v700_practitioner_role
