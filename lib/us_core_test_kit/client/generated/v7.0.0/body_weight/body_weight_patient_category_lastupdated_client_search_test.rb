...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class BodyWeightPatientCategoryLastupdatedClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v700_body_weight_patient_category_lastupdated_client_search_test
        title 'SHOULD support patient + category + _lastUpdated search of BodyWeight'
        description %(
          The client demonstrates SHOULD support for searching patient + category + _lastUpdated on BodyWeight.
        )
        optional true
