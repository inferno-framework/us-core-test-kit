  ...
  module Client
    module USCoreClientV700
      class BodyWeightPatientCodeClientSearchTest < Inferno::Test
        ...
        id :us_core_v700_body_weight_patient_code_client_search_test

        title 'SHALL support patient + code search of BodyWeight'

        description %(
          The client demonstrates SHALL support for searching patient + code on BodyWeight.
        )
