...
require_relative 'heart_rate/heart_rate_client_support_test'
...
require_relative 'heart_rate/heart_rate_patient_category_lastupdated_client_search_test'
  ...
  module Client
    module USCoreClientV700
      class HeartRateClientGroup < Inferno::TestGroup
        id :us_core_client_v700_heart_rate
...
* patient + category + _lastUpdated
        ...
        test from: :us_core_v700_heart_rate_client_support_test
        test from: :us_core_v700_heart_rate_client_read_test
        test from: :us_core_v700_heart_rate_patient_code_client_search_test
        test from: :us_core_v700_heart_rate_patient_category_date_client_search_test
        test from: :us_core_v700_heart_rate_patient_code_date_client_search_test
        test from: :us_core_v700_heart_rate_patient_category_status_client_search_test
        test from: :us_core_v700_heart_rate_patient_category_lastupdated_client_search_test
        test from: :us_core_v700_heart_rate_patient_category_client_search_test
      end
    end
  end
end
