...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class SmokingstatusClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_smokingstatus_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-smokingstatus` for the US Core Smoking Status Observation Profile.
