...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class TreatmentInterventionPreferenceClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_treatment_intervention_preference_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-treatment-intervention-preference` for the US Core Treatment Intervention Preference Profile.
