  ...
  module Client
    module USCoreClientV700
      class CareTeamClientGroup < Inferno::TestGroup
        id :us_core_client_v700_care_team
        title 'CareTeam'
        description %(
...
* patient + role
        ...
        test from: :us_core_v700_care_team_client_support_test
        test from: :us_core_v700_care_team_client_read_test
        test from: :us_core_v700_care_team_patient_status_client_search_test
        test from: :us_core_v700_care_team_role_client_search_test
        test from: :us_core_v700_care_team_patient_role_client_search_test
      end
    end
  end
end
