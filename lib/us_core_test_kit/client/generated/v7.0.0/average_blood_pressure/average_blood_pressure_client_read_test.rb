  ...
  module Client
    module USCoreClientV700
      class AverageBloodPressureClientReadTest < Inferno::Test
        ...
        id :us_core_v700_average_blood_pressure_client_read_test
        ...
        def failure_message
          "Did not receive a request for `Observation` with id: `us-core-client-tests-average-blood-pressure`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests_of_type, 'us-core-client-tests-average-blood-pressure')
