...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class AverageBloodPressureClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_average_blood_pressure_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-average-blood-pressure` for the US Core Average Blood Pressure Profile.
