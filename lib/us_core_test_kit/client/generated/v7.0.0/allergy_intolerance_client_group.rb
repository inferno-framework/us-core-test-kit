  ...
  module Client
    module USCoreClientV700
      class AllergyIntoleranceClientGroup < Inferno::TestGroup
        id :us_core_client_v700_allergy_intolerance
...
* patient + clinical-status
        ...
        test from: :us_core_v700_allergy_intolerance_client_support_test
        test from: :us_core_v700_allergy_intolerance_client_read_test
        test from: :us_core_v700_allergy_intolerance_patient_client_search_test
        test from: :us_core_v700_allergy_intolerance_patient_clinical_status_client_search_test
      end
    end
  end
end
