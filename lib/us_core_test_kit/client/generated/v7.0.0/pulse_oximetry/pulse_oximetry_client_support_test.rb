...
module USCoreTestKit
  module Client
    module USCoreClientV700
      class PulseOximetryClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v700_pulse_oximetry_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-pulse-oximetry` for the US Core Pulse Oximetry Profile.
