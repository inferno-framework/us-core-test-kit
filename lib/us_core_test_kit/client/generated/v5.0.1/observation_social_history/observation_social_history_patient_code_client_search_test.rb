...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationSocialHistoryPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_social_history_patient_code_client_search_test

        title 'SHALL support patient + code search of ObservationSocialHistory'

        description %(
          The client demonstrates SHALL support for searching patient + code on ObservationSocialHistory.
        )
