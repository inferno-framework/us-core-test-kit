...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationSocialHistoryPatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_social_history_patient_category_client_search_test

        title 'SHALL support patient + category search of ObservationSocialHistory'

        description %(
          The client demonstrates SHALL support for searching patient + category on ObservationSocialHistory.
        )
