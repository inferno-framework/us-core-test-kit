...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationSocialHistoryPatientCategoryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_social_history_patient_category_status_client_search_test
        title 'SHOULD support patient + category + status search of ObservationSocialHistory'
        description %(
          The client demonstrates SHOULD support for searching patient + category + status on ObservationSocialHistory.
        )
        optional true
