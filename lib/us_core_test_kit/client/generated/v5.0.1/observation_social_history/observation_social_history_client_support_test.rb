...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationSocialHistoryClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_social_history_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-social-history` for the US Core Observation Social History Profile.
