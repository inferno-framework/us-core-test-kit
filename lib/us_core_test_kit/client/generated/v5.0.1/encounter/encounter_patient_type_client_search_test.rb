...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class EncounterPatientTypeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_encounter_patient_type_client_search_test
        title 'SHOULD support patient + type search of Encounter'
        description %(
          The client demonstrates SHOULD support for searching patient + type on Encounter.
        )
        optional true
