...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ProcedurePatientCodeDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_procedure_patient_code_date_client_search_test
        title 'SHOULD support patient + code + date search of Procedure'
        description %(
          The client demonstrates SHOULD support for searching patient + code + date on Procedure.
        )
        optional true
