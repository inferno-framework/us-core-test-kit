  ...
  module Client
    module USCoreClientV501
      class PulseOximetryPatientCodeClientSearchTest < Inferno::Test
        ...
        id :us_core_v501_pulse_oximetry_patient_code_client_search_test

        title 'SHALL support patient + code search of PulseOximetry'

        description %(
          The client demonstrates SHALL support for searching patient + code on PulseOximetry.
        )
