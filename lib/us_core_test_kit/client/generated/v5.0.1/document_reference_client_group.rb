  ...
  module Client
    module USCoreClientV501
      class DocumentReferenceClientGroup < Inferno::TestGroup
        id :us_core_client_v501_document_reference
...
* patient + type + period
        ...
        test from: :us_core_v501_document_reference_client_support_test
        test from: :us_core_v501_document_reference_client_read_test
        test from: :us_core_v501_document_reference_patient_client_search_test
        test from: :us_core_v501_document_reference_id_client_search_test
        test from: :us_core_v501_document_reference_patient_category_date_client_search_test
        test from: :us_core_v501_document_reference_patient_status_client_search_test
        test from: :us_core_v501_document_reference_patient_category_client_search_test
        test from: :us_core_v501_document_reference_patient_type_period_client_search_test
        test from: :us_core_v501_document_reference_patient_type_client_search_test
      end
    end
  end
end
