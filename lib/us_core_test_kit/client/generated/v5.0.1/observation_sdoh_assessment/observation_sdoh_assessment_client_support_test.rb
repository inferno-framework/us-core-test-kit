...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationSdohAssessmentClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_sdoh_assessment_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-sdoh-assessment` for the US Core Observation SDOH Assessment Profile.
