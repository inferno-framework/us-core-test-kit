...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationSdohAssessmentPatientCategoryDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_sdoh_assessment_patient_category_date_client_search_test
        title 'SHALL support patient + category + date search of ObservationSdohAssessment'
        description %(
          The client demonstrates SHALL support for searching patient + category + date on ObservationSdohAssessment.
        )
        optional false
