...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationSdohAssessmentPatientCategoryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_sdoh_assessment_patient_category_status_client_search_test
        title 'SHOULD support patient + category + status search of ObservationSdohAssessment'
        description %(
          The client demonstrates SHOULD support for searching patient + category + status on ObservationSdohAssessment.
        )
        optional true
