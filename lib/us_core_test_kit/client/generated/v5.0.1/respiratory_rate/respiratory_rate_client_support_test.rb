...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class RespiratoryRateClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_respiratory_rate_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-respiratory-rate` for the US Core Respiratory Rate Profile.
