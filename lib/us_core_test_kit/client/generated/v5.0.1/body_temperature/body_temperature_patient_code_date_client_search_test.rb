...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class BodyTemperaturePatientCodeDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_body_temperature_patient_code_date_client_search_test
        title 'SHOULD support patient + code + date search of BodyTemperature'
        description %(
          The client demonstrates SHOULD support for searching patient + code + date on BodyTemperature.
        )
        optional true
