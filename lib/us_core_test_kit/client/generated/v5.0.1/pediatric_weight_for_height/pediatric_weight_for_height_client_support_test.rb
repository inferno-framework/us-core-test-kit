...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class PediatricWeightForHeightClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_pediatric_weight_for_height_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-pediatric-weight-for-height` for the US Core Pediatric Weight for Height Observation Profile.
