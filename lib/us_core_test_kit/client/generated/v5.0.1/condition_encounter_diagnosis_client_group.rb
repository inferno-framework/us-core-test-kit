...
* patient + clinical-status
        ...
        test from: :us_core_v501_condition_encounter_diagnosis_patient_asserted_date_client_search_test
        test from: :us_core_v501_condition_encounter_diagnosis_patient_code_client_search_test
        test from: :us_core_v501_condition_encounter_diagnosis_patient_category_encounter_client_search_test
        test from: :us_core_v501_condition_encounter_diagnosis_patient_category_client_search_test
        test from: :us_core_v501_condition_encounter_diagnosis_patient_recorded_date_client_search_test
        test from: :us_core_v501_condition_encounter_diagnosis_patient_onset_date_client_search_test
        test from: :us_core_v501_condition_encounter_diagnosis_patient_clinical_status_client_search_test
      end
    end
  end
end
