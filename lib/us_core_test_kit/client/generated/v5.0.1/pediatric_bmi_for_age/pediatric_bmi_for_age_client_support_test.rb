...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class PediatricBmiForAgeClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_pediatric_bmi_for_age_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-pediatric-bmi-for-age` for the US Core Pediatric BMI for Age Observation Profile.
