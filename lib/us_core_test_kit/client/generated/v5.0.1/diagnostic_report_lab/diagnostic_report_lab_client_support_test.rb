...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class DiagnosticReportLabClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_diagnostic_report_lab_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-diagnostic-report-lab` for the US Core DiagnosticReport Profile for Laboratory Results Reporting.
