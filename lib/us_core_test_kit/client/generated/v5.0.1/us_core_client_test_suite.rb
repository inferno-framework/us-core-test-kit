...
to the [US Core Implementation Guide](http://hl7.org/fhir/us/core/STU5.0.1).
...
* **[US Core Patient Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-patient|5.0.1)** (id: us-core-client-tests-patient)
* **[US Core AllergyIntolerance Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-allergyintolerance|5.0.1)** (id: us-core-client-tests-allergy-intolerance)
* **[US Core CarePlan Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-careplan|5.0.1)** (id: us-core-client-tests-care-plan)
* **[US Core CareTeam Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-careteam|5.0.1)** (id: us-core-client-tests-care-team)
* **[US Core Condition Encounter Diagnosis Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-condition-encounter-diagnosis|5.0.1)** (id: us-core-client-tests-condition-encounter-diagnosis)
* **[US Core Condition Problems and Health Concerns Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-condition-problems-health-concerns|5.0.1)** (id: us-core-client-tests-condition-problems-health-concerns)
* **[US Core Implantable Device Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-implantable-device|5.0.1)** (id: us-core-client-tests-device)
* **[US Core DiagnosticReport Profile for Report and Note Exchange](http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-note|5.0.1)** (id: us-core-client-tests-diagnostic-report-note)
* **[US Core DiagnosticReport Profile for Laboratory Results Reporting](http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab|5.0.1)** (id: us-core-client-tests-diagnostic-report-lab)
* **[US Core DocumentReference Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-documentreference|5.0.1)** (id: us-core-client-tests-document-reference)
* **[US Core Encounter Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-encounter|5.0.1)** (id: us-core-client-tests-encounter)
* **[US Core Goal Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-goal|5.0.1)** (id: us-core-client-tests-goal)
* **[US Core Immunization Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-immunization|5.0.1)** (id: us-core-client-tests-immunization)
* **[US Core MedicationRequest Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationrequest|5.0.1)** (id: us-core-client-tests-medication-request)
* **[US Core Laboratory Result Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-lab|5.0.1)** (id: us-core-client-tests-observation-lab)
* **[US Core Observation SDOH Assessment Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-sdoh-assessment|5.0.1)** (id: us-core-client-tests-observation-sdoh-assessment)
* **[US Core Respiratory Rate Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-respiratory-rate|5.0.1)** (id: us-core-client-tests-respiratory-rate)
* **[US Core Observation Social History Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-social-history|5.0.1)** (id: us-core-client-tests-observation-social-history)
* **[US Core Heart Rate Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-heart-rate|5.0.1)** (id: us-core-client-tests-heart-rate)
* **[US Core Body Temperature Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-temperature|5.0.1)** (id: us-core-client-tests-body-temperature)
* **[US Core Pediatric Weight for Height Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height|5.0.1)** (id: us-core-client-tests-pediatric-weight-for-height)
* **[US Core Pulse Oximetry Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry|5.0.1)** (id: us-core-client-tests-pulse-oximetry)
* **[US Core Smoking Status Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-smokingstatus|5.0.1)** (id: us-core-client-tests-smokingstatus)
* **[US Core Observation Sexual Orientation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-sexual-orientation|5.0.1)** (id: us-core-client-tests-observation-sexual-orientation)
* **[US Core Head Circumference Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-head-circumference|5.0.1)** (id: us-core-client-tests-head-circumference-percentile)
* **[US Core Body Height Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-height|5.0.1)** (id: us-core-client-tests-body-height)
* **[US Core BMI Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi|5.0.1)** (id: us-core-client-tests-bmi)
* **[US Core Blood Pressure Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-blood-pressure|5.0.1)** (id: us-core-client-tests-blood-pressure)
* **[US Core Observation Imaging Result Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-imaging|5.0.1)** (id: us-core-client-tests-observation-imaging)
* **[US Core Observation Clinical Test Result Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-clinical-test|5.0.1)** (id: us-core-client-tests-observation-clinical-test)
* **[US Core Pediatric BMI for Age Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/pediatric-bmi-for-age|5.0.1)** (id: us-core-client-tests-pediatric-bmi-for-age)
* **[US Core Pediatric Head Occipital-frontal Circumference Percentile Profile](http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile|5.0.1)** (id: us-core-client-tests-head-circumference-percentile)
* **[US Core Body Weight Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-weight|5.0.1)** (id: us-core-client-tests-body-weight)
* **[US Core Procedure Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-procedure|5.0.1)** (id: us-core-client-tests-procedure)
* **[US Core QuestionnaireResponse Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-questionnaireresponse|5.0.1)** (id: us-core-client-tests-questionnaire-response)
* **[US Core ServiceRequest Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-servicerequest|5.0.1)** (id: us-core-client-tests-service-request)
* **[US Core Organization Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-organization|5.0.1)** (id: us-core-client-tests-organization)
* **[US Core Practitioner Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitioner|5.0.1)** (id: us-core-client-tests-practitioner)
* **[US Core PractitionerRole Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitionerrole|5.0.1)** (id: us-core-client-tests-practitioner-role)
* **[US Core Provenance Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-provenance|5.0.1)** (id: us-core-client-tests-provenance)
* **[US Core RelatedPerson Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-relatedperson|5.0.1)** (id: us-core-client-tests-related-person)
...
- Testing a client's ability to perform read requests against a FHIR server for all US Core Profiles
  listed in the [US Core Client CapabilityStatement](http://hl7.org/fhir/us/core/STU5.0.1/CapabilityStatement-us-core-client.html).
- Testing a client's ability to perform searches using search parameters and combinations
  listed for each resource type in the [US Core Client CapabilityStatement](http://hl7.org/fhir/us/core/STU5.0.1/CapabilityStatement-us-core-client.html).
...
- Check the Must Support Conformance Requirements for clients/requestors specified in US Core IG v5.0.1
...
- Allow testers to bring their own data. Testers must manually configure their client system to connect
  to a specific target patient and must access and process specific curated sample US Core data.
        ...
        group do
          id :us_core_client_read_search_group_v501
          title 'Read & Search'
          description %(
            
During these tests, the US Core client system will interact with Inferno's simulated US Core Server
and demonstrate its ability to perform the FHIR interactions described in the [US Core Client CapabilityStatement](http://hl7.org/fhir/us/core/STU5.0.1/CapabilityStatement-us-core-client.html).


          )

          group from: :us_core_client_access_group_v501
