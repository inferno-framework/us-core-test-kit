  ...
  module Client
    module USCoreClientV501
      class CarePlanClientGroup < Inferno::TestGroup
        id :us_core_client_v501_care_plan
        title 'CarePlan'
        description %(
...
* patient + category + status
        ...
        test from: :us_core_v501_care_plan_client_support_test
        test from: :us_core_v501_care_plan_client_read_test
        test from: :us_core_v501_care_plan_patient_category_client_search_test
        test from: :us_core_v501_care_plan_patient_category_status_date_client_search_test
        test from: :us_core_v501_care_plan_patient_category_date_client_search_test
        test from: :us_core_v501_care_plan_patient_category_status_client_search_test
      end
    end
  end
end
