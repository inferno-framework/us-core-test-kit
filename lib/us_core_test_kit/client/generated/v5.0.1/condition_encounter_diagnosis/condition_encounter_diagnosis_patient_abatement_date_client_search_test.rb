...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ConditionEncounterDiagnosisPatientAbatementDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_condition_encounter_diagnosis_patient_abatement_date_client_search_test
        title 'SHOULD support patient + abatement-date search of ConditionEncounterDiagnosis'
        description %(
          The client demonstrates SHOULD support for searching patient + abatement-date on ConditionEncounterDiagnosis.
        )
        optional true
