...
* patient + code + date
        ...
        test from: :us_core_v501_diagnostic_report_note_client_support_test
        ...
        test from: :us_core_v501_diagnostic_report_note_patient_status_client_search_test
        test from: :us_core_v501_diagnostic_report_note_patient_code_client_search_test
        test from: :us_core_v501_diagnostic_report_note_patient_code_date_client_search_test
      end
    end
  end
end
