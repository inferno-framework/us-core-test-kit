  ...
  module Client
    module USCoreClientV501
      class BodyWeightClientReadTest < Inferno::Test
        ...
        id :us_core_v501_body_weight_client_read_test
        ...
        def failure_message
          "Did not receive a request for `Observation` with id: `us-core-client-tests-body-weight`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests_of_type, 'us-core-client-tests-body-weight')
