  ...
  module Client
    module USCoreClientV501
      class ConditionProblemsHealthConcernsPatientCategoryClientSearchTest < Inferno::Test
        ...
        id :us_core_v501_condition_problems_health_concerns_patient_category_client_search_test
        title 'SHOULD support patient + category search of ConditionProblemsHealthConcerns'
        description %(
          The client demonstrates SHOULD support for searching patient + category on ConditionProblemsHealthConcerns.
        )
        optional true
