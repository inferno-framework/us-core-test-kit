  ...
  module Client
    module USCoreClientV501
      class EncounterClientGroup < Inferno::TestGroup
        id :us_core_client_v501_encounter
        title 'Encounter'
        description %(
...
* patient + type
        ...
        test from: :us_core_v501_encounter_client_support_test
        test from: :us_core_v501_encounter_client_read_test
        test from: :us_core_v501_encounter_patient_client_search_test
        test from: :us_core_v501_encounter_id_client_search_test
        test from: :us_core_v501_encounter_identifier_client_search_test
        test from: :us_core_v501_encounter_patient_discharge_disposition_client_search_test
        test from: :us_core_v501_encounter_class_patient_client_search_test
        test from: :us_core_v501_encounter_patient_location_client_search_test
        test from: :us_core_v501_encounter_date_patient_client_search_test
        test from: :us_core_v501_encounter_patient_status_client_search_test
        test from: :us_core_v501_encounter_patient_type_client_search_test
      end
    end
  end
end
