...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class HeadCircumferencePercentileClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_head_circumference_percentile_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-head-circumference-percentile` for the US Core Pediatric Head Occipital-frontal Circumference Percentile Profile.
