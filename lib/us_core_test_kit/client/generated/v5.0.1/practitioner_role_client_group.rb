...
require_relative 'practitioner_role/practitioner_role_client_support_test'
  ...
  module Client
    module USCoreClientV501
      class PractitionerRoleClientGroup < Inferno::TestGroup
        id :us_core_client_v501_practitioner_role
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_core_v501_practitioner_role_client_support_test
        test from: :us_core_v501_practitioner_role_client_read_test
        test from: :us_core_v501_practitioner_role_specialty_client_search_test
        test from: :us_core_v501_practitioner_role_practitioner_client_search_test
      end
    end
  end
end
