  ...
  module Client
    module USCoreClientV501
      class ConditionProblemsHealthConcernsClientGroup < Inferno::TestGroup
        id :us_core_client_v501_condition_problems_health_concerns
...
* patient + clinical-status
        ...
        test from: :us_core_v501_condition_problems_health_concerns_client_support_test
        test from: :us_core_v501_condition_problems_health_concerns_client_read_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_client_search_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_abatement_date_client_search_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_asserted_date_client_search_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_code_client_search_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_category_encounter_client_search_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_category_client_search_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_recorded_date_client_search_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_onset_date_client_search_test
        test from: :us_core_v501_condition_problems_health_concerns_patient_clinical_status_client_search_test
      end
    end
  end
end
