...
* patient + category + status
        ...
        test from: :us_core_v501_bmi_client_support_test
        ...
        test from: :us_core_v501_bmi_patient_code_date_client_search_test
        test from: :us_core_v501_bmi_patient_category_client_search_test
        test from: :us_core_v501_bmi_patient_category_status_client_search_test
      end
    end
  end
end
