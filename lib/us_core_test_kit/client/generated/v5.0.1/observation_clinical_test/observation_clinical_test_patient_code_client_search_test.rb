...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationClinicalTestPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_clinical_test_patient_code_client_search_test
        title 'SHALL support patient + code search of ObservationClinicalTest'
        description %(
          The client demonstrates SHALL support for searching patient + code on ObservationClinicalTest.
        )
        optional false
