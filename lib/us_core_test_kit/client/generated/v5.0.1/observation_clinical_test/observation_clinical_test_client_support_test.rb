...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationClinicalTestClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_clinical_test_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-clinical-test` for the US Core Observation Clinical Test Result Profile.
