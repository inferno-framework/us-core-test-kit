...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationClinicalTestPatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_clinical_test_patient_category_client_search_test

        title 'SHALL support patient + category search of ObservationClinicalTest'

        description %(
          The client demonstrates SHALL support for searching patient + category on ObservationClinicalTest.
        )
