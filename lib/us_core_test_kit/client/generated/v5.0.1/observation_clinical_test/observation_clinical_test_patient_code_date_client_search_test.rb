...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationClinicalTestPatientCodeDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_clinical_test_patient_code_date_client_search_test
        title 'SHOULD support patient + code + date search of ObservationClinicalTest'
        description %(
          The client demonstrates SHOULD support for searching patient + code + date on ObservationClinicalTest.
        )
        optional true
