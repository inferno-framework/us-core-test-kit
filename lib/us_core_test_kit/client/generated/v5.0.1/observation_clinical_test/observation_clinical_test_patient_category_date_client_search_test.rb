...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationClinicalTestPatientCategoryDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_clinical_test_patient_category_date_client_search_test

        title 'SHALL support patient + category + date search of ObservationClinicalTest'

        description %(
          The client demonstrates SHALL support for searching patient + category + date on ObservationClinicalTest.
        )
