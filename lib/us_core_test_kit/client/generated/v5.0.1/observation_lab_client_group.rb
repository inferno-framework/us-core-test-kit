  ...
  module Client
    module USCoreClientV501
      class ObservationLabClientGroup < Inferno::TestGroup
        id :us_core_client_v501_observation_lab
...
* patient + category + status
        ...
        test from: :us_core_v501_observation_lab_client_support_test
        test from: :us_core_v501_observation_lab_client_read_test
        test from: :us_core_v501_observation_lab_patient_category_client_search_test
        test from: :us_core_v501_observation_lab_patient_category_date_client_search_test
        test from: :us_core_v501_observation_lab_patient_code_client_search_test
        test from: :us_core_v501_observation_lab_patient_code_date_client_search_test
        test from: :us_core_v501_observation_lab_patient_category_status_client_search_test
      end
    end
  end
end
