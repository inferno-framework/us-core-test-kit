...
module USCoreTestKit
  module Client
    module USCoreClientV501
      class ObservationImagingClientSupportTest < Inferno::Test
        include TestHelper

        id :us_core_v501_observation_imaging_client_support_test
        ...
        description %(
            ...
            instance `us-core-client-tests-observation-imaging` for the US Core Observation Imaging Result Profile.
