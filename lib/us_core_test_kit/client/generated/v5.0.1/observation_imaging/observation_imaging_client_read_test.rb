  ...
  module Client
    module USCoreClientV501
      class ObservationImagingClientReadTest < Inferno::Test
        ...
        def failure_message
          "Did not receive a request for `Observation` with id: `us-core-client-tests-observation-imaging`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests_of_type, 'us-core-client-tests-observation-imaging')
