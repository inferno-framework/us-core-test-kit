...
read succeeds.
      ...
      test from: :us_core_v600_practitioner_read_test
      test from: :us_core_v600_practitioner__id_search_test
      test from: :us_core_v600_practitioner_name_search_test
      test from: :us_core_v600_practitioner_identifier_search_test
      test from: :us_core_v600_practitioner_validation_test
      test from: :us_core_v600_practitioner_must_support_test
    end
  end
end
