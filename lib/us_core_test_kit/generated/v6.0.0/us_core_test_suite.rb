...
require_relative '../../custom_groups/v6.0.0/capability_statement_group'
...
module USCoreTestKit
  module USCoreV600
    class USCoreTestSuite < Inferno::TestSuite
      ...
      validator do
        url ENV.fetch('V600_VALIDATOR_URL', 'http://validator_service:4567')
      ...
      group from: :us_core_v600_capability_statement
  
      group from: :us_core_v600_patient
      group from: :us_core_v600_allergy_intolerance
      group from: :us_core_v600_care_plan
      group from: :us_core_v600_care_team
      group from: :us_core_v600_condition_encounter_diagnosis
      group from: :us_core_v600_condition_problems_health_concerns
      group from: :us_core_v600_coverage
      group from: :us_core_v600_device
      group from: :us_core_v600_diagnostic_report_note
      group from: :us_core_v600_diagnostic_report_lab
      group from: :us_core_v600_document_reference
      group from: :us_core_v600_encounter
      group from: :us_core_v600_goal
      group from: :us_core_v600_immunization
      group from: :us_core_v600_medication_dispense
      group from: :us_core_v600_medication_request
      group from: :us_core_v600_observation_lab
      group from: :us_core_v600_observation_pregnancystatus
      group from: :us_core_v600_observation_pregnancyintent
      group from: :us_core_v600_observation_occupation
      group from: :us_core_v600_respiratory_rate
      group from: :us_core_v600_simple_observation
      group from: :us_core_v600_heart_rate
      group from: :us_core_v600_body_temperature
      group from: :us_core_v600_pediatric_weight_for_height
      group from: :us_core_v600_pulse_oximetry
      group from: :us_core_v600_smokingstatus
      group from: :us_core_v600_observation_sexual_orientation
      group from: :us_core_v600_head_circumference
      group from: :us_core_v600_body_height
      group from: :us_core_v600_bmi
      group from: :us_core_v600_observation_screening_assessment
      group from: :us_core_v600_blood_pressure
      group from: :us_core_v600_observation_clinical_result
      group from: :us_core_v600_pediatric_bmi_for_age
      group from: :us_core_v600_head_circumference_percentile
