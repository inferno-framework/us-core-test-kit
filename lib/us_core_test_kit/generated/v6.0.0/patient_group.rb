...
read succeeds.
      ...
      test from: :us_core_v600_patient__id_search_test
      test from: :us_core_v600_patient_identifier_search_test
      test from: :us_core_v600_patient_name_search_test
      test from: :us_core_v600_patient_birthdate_family_search_test
      test from: :us_core_v600_patient_family_gender_search_test
      test from: :us_core_v600_patient_birthdate_name_search_test
      test from: :us_core_v600_patient_gender_name_search_test
      test from: :us_core_v600_patient_death_date_family_search_test
      test from: :us_core_v600_patient_read_test
      test from: :us_core_v600_patient_provenance_revinclude_search_test
      test from: :us_core_v600_patient_validation_test
      test from: :us_core_v600_patient_must_support_test
    end
  end
end
