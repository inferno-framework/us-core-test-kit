...
read succeeds.
      ...
      id :us_core_v501_diagnostic_report_note
      run_as_group

      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'diagnostic_report_note', 'metadata.yml')))
      end
  
      test from: :us_core_v501_diagnostic_report_note_patient_category_search_test
      test from: :us_core_v501_diagnostic_report_note_patient_search_test
      test from: :us_core_v501_diagnostic_report_note_patient_category_date_search_test
      test from: :us_core_v501_diagnostic_report_note_patient_status_search_test
      test from: :us_core_v501_diagnostic_report_note_patient_code_search_test
      test from: :us_core_v501_diagnostic_report_note_patient_code_date_search_test
      test from: :us_core_v501_diagnostic_report_note_read_test
      test from: :us_core_v501_diagnostic_report_note_provenance_revinclude_search_test
      test from: :us_core_v501_diagnostic_report_note_validation_test
      test from: :us_core_v501_diagnostic_report_note_must_support_test
      test from: :us_core_v501_diagnostic_report_note_reference_resolution_test
    end
  end
end
