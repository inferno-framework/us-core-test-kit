...
read succeeds.
      ...
      id :us_core_v700_ballot_pediatric_weight_for_height
      run_as_group
      ...
      test from: :us_core_v700_ballot_pediatric_weight_for_height_patient_code_search_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_patient_category_search_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_patient_category_date_search_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_patient_category_status_search_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_patient_code_date_search_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_read_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_provenance_revinclude_search_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_validation_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_must_support_test
      test from: :us_core_v700_ballot_pediatric_weight_for_height_reference_resolution_test
    end
  end
end
