...
read succeeds.
      ...
      id :us_core_v700_ballot_organization
      run_as_group
      ...
      test from: :us_core_v700_ballot_organization_read_test
      test from: :us_core_v700_ballot_organization_address_search_test
      test from: :us_core_v700_ballot_organization_name_search_test
      test from: :us_core_v700_ballot_organization_validation_test
      test from: :us_core_v700_ballot_organization_must_support_test
    end
  end
end
