...
read succeeds.
      ...
      id :us_core_v700_ballot_diagnostic_report_lab
      run_as_group
      ...
      test from: :us_core_v700_ballot_diagnostic_report_lab_patient_category_search_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_patient_search_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_patient_category_date_search_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_patient_code_search_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_patient_status_search_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_patient_code_date_search_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_read_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_provenance_revinclude_search_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_validation_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_must_support_test
      test from: :us_core_v700_ballot_diagnostic_report_lab_reference_resolution_test
    end
  end
end
