...
read succeeds.
      ...
      id :us_core_v700_ballot_head_circumference_percentile
      run_as_group
      ...
      test from: :us_core_v700_ballot_head_circumference_percentile_patient_code_search_test
      test from: :us_core_v700_ballot_head_circumference_percentile_patient_category_search_test
      test from: :us_core_v700_ballot_head_circumference_percentile_patient_category_date_search_test
      test from: :us_core_v700_ballot_head_circumference_percentile_patient_category_status_search_test
      test from: :us_core_v700_ballot_head_circumference_percentile_patient_code_date_search_test
      test from: :us_core_v700_ballot_head_circumference_percentile_read_test
      test from: :us_core_v700_ballot_head_circumference_percentile_provenance_revinclude_search_test
      test from: :us_core_v700_ballot_head_circumference_percentile_validation_test
      test from: :us_core_v700_ballot_head_circumference_percentile_must_support_test
      test from: :us_core_v700_ballot_head_circumference_percentile_reference_resolution_test
    end
  end
end
