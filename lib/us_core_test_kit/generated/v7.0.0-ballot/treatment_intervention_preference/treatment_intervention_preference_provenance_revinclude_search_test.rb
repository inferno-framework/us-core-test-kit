...
module USCoreTestKit
  module USCoreV700_BALLOT
    class TreatmentInterventionPreferenceProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v700_ballot_treatment_intervention_preference_provenance_revinclude_search_test
