...
module USCoreTestKit
  module USCoreV700_BALLOT
    class TreatmentInterventionPreferenceReferenceResolutionTest < Inferno::Test
      ...
      id :us_core_v700_ballot_treatment_intervention_preference_reference_resolution_test
