...
module USCoreTestKit
  module USCoreV700_BALLOT
    class DocumentReferencePatientStatusGranularScopeTest < Inferno::Test
      include USCoreTestKit::SearchTest
      include USCoreTestKit::GranularScopeChecker

      title 'Server filters results for DocumentReference search by patient + status based on granular scopes'
      description %(
...
filtered based on the granted granular scopes.
      ...
      id :us_core_v700_ballot_DocumentReference_patient_status_granular_scope_test
