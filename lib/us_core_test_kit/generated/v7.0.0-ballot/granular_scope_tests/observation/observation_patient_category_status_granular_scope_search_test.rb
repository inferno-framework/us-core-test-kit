...
module USCoreTestKit
  module USCoreV700_BALLOT
    class ObservationPatientCategoryStatusGranularScopeSearchTest < Inferno::Test
      include USCoreTestKit::SearchTest
      include USCoreTestKit::GranularScopeSearchTest

      title 'Server filters results for Observation search by patient + category + status based on granular scopes'
      description %(
...
filtered based on the granted granular scopes.
      ...
      id :us_core_v700_ballot_Observation_patient_category_status_granular_scope_search_test
