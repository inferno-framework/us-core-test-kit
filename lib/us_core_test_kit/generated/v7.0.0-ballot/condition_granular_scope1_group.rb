...
* `Condition.rs?category=http://hl7.org/fhir/us/core/CodeSystem/condition-category|health-concern`
      ...
      id :us_core_v700_ballot_condition_granular_scope_1_group
      run_as_group

    
      test from: :us_core_v700_ballot_Condition_patient_category_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_asserted_date_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_onset_date_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_code_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_recorded_date_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_abatement_date_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_category_clinical_status_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_category_encounter_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_patient_clinical_status_granular_scope_search_test
      test from: :us_core_v700_ballot_Condition_granular_scope_read_test
    end
  end
end
