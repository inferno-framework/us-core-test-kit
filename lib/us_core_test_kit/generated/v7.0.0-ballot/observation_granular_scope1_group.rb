...
require_relative './granular_scope_tests/observation/observation_read_granular_scope_test'
...
* `Observation.rs?category=http://terminology.hl7.org/CodeSystem/observation-category|procedure`
      ...
      test from: :us_core_v700_ballot_Observation_read_granular_scope_test
    end
  end
end
