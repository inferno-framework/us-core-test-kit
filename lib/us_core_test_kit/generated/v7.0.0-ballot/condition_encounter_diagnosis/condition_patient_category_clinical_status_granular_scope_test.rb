...
module USCoreTestKit
  module USCoreV700_BALLOT
    class ConditionPatientCategoryClinicalStatusGranularScopeTest < Inferno::Test
...
filtered based on the granted granular scopes.
      ...
      id :us_core_v700_ballot_Condition_patient_category_clinical_status_granular_scope_test
