...
read succeeds.
      ...
      id :us_core_v700_ballot_condition_encounter_diagnosis
      run_as_group
      ...
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_patient_recorded_date_search_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_patient_abatement_date_search_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_patient_category_clinical_status_search_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_patient_category_encounter_search_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_patient_clinical_status_search_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_read_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_provenance_revinclude_search_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_validation_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_must_support_test
      test from: :us_core_v700_ballot_condition_encounter_diagnosis_reference_resolution_test
    end
  end
end
