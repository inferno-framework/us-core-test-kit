...
read succeeds.
      ...
      id :us_core_v700_ballot_provenance
      run_as_group
      ...
      test from: :us_core_v700_ballot_provenance_read_test
      test from: :us_core_v700_ballot_provenance_validation_test
      test from: :us_core_v700_ballot_provenance_must_support_test
      test from: :us_core_v700_ballot_provenance_reference_resolution_test
    end
  end
end
