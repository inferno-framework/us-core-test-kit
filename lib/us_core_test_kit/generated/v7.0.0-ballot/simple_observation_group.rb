...
read succeeds.
      ...
      id :us_core_v700_ballot_simple_observation
      run_as_group
      optional
      ...
      test from: :us_core_v700_ballot_simple_observation_patient_category_search_test
      test from: :us_core_v700_ballot_simple_observation_patient_category_date_search_test
      test from: :us_core_v700_ballot_simple_observation_patient_code_search_test
      test from: :us_core_v700_ballot_simple_observation_patient_category_status_search_test
      test from: :us_core_v700_ballot_simple_observation_patient_code_date_search_test
      test from: :us_core_v700_ballot_simple_observation_read_test
      test from: :us_core_v700_ballot_simple_observation_provenance_revinclude_search_test
      test from: :us_core_v700_ballot_simple_observation_validation_test
      test from: :us_core_v700_ballot_simple_observation_must_support_test
      test from: :us_core_v700_ballot_simple_observation_reference_resolution_test
    end
  end
end
