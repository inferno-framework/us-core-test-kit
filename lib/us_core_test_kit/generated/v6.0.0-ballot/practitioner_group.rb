...
read succeeds.
      ...
      id :us_core_v600_ballot_practitioner
      run_as_group
      ...
      test from: :us_core_v600_ballot_practitioner_read_test
      test from: :us_core_v600_ballot_practitioner__id_search_test
      test from: :us_core_v600_ballot_practitioner_name_search_test
      test from: :us_core_v600_ballot_practitioner_identifier_search_test
      test from: :us_core_v600_ballot_practitioner_validation_test
      test from: :us_core_v600_ballot_practitioner_must_support_test
    end
  end
end
