...
read succeeds.
      ...
      id :us_core_v600_ballot_observation_screening_assessment
      run_as_group
      ...
      test from: :us_core_v600_ballot_observation_screening_assessment_validation_test
      test from: :us_core_v600_ballot_observation_screening_assessment_must_support_test
      test from: :us_core_v600_ballot_observation_screening_assessment_reference_resolution_test
    end
  end
end
