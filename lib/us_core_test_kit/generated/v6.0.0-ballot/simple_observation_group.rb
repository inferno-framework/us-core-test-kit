...
read succeeds.
      ...
      id :us_core_v600_ballot_simple_observation
      run_as_group
      optional
      ...
      test from: :us_core_v600_ballot_simple_observation_validation_test
      test from: :us_core_v600_ballot_simple_observation_must_support_test
      test from: :us_core_v600_ballot_simple_observation_reference_resolution_test
    end
  end
end
