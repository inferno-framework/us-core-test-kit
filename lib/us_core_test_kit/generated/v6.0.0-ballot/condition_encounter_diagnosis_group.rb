...
read succeeds.
      ...
      id :us_core_v600_ballot_condition_encounter_diagnosis
      run_as_group
      ...
      test from: :us_core_v600_ballot_condition_encounter_diagnosis_provenance_revinclude_search_test
      test from: :us_core_v600_ballot_condition_encounter_diagnosis_validation_test
      test from: :us_core_v600_ballot_condition_encounter_diagnosis_must_support_test
      test from: :us_core_v600_ballot_condition_encounter_diagnosis_reference_resolution_test
    end
  end
end
