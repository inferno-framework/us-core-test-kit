...
read succeeds.
      ...
      id :us_core_v600_ballot_medication_request
      run_as_group
      ...
      test from: :us_core_v600_ballot_medication_request_patient_intent_search_test
      test from: :us_core_v600_ballot_medication_request_patient_intent_authoredon_search_test
      test from: :us_core_v600_ballot_medication_request_patient_intent_encounter_search_test
      test from: :us_core_v600_ballot_medication_request_patient_intent_status_search_test
      test from: :us_core_v600_ballot_medication_request_read_test
      test from: :us_core_v600_ballot_medication_request_provenance_revinclude_search_test
      test from: :us_core_v600_ballot_medication_request_validation_test
      test from: :us_core_v600_ballot_medication_validation_test
      test from: :us_core_v600_ballot_medication_request_must_support_test
      test from: :us_core_v600_ballot_medication_request_reference_resolution_test
    end
  end
end
