...
read succeeds.
      ...
      id :us_core_v600_ballot_condition_problems_health_concerns
      run_as_group
      ...
      test from: :us_core_v600_ballot_condition_problems_health_concerns_provenance_revinclude_search_test
      test from: :us_core_v600_ballot_condition_problems_health_concerns_validation_test
      test from: :us_core_v600_ballot_condition_problems_health_concerns_must_support_test
      test from: :us_core_v600_ballot_condition_problems_health_concerns_reference_resolution_test
    end
  end
end
