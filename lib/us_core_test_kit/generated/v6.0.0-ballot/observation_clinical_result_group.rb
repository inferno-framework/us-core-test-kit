...
read succeeds.
      ...
      id :us_core_v600_ballot_observation_clinical_result
      run_as_group
      ...
      test from: :us_core_v600_ballot_observation_clinical_result_validation_test
      test from: :us_core_v600_ballot_observation_clinical_result_must_support_test
      test from: :us_core_v600_ballot_observation_clinical_result_reference_resolution_test
    end
  end
end
