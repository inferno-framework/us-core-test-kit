...
read succeeds.
      ...
      id :us_core_v600_ballot_encounter
      run_as_group
      ...
      test from: :us_core_v600_ballot_encounter_patient_search_test
      test from: :us_core_v600_ballot_encounter__id_search_test
      test from: :us_core_v600_ballot_encounter_identifier_search_test
      test from: :us_core_v600_ballot_encounter_patient_type_search_test
      test from: :us_core_v600_ballot_encounter_date_patient_search_test
      test from: :us_core_v600_ballot_encounter_patient_status_search_test
      test from: :us_core_v600_ballot_encounter_class_patient_search_test
      test from: :us_core_v600_ballot_encounter_patient_discharge_disposition_search_test
      test from: :us_core_v600_ballot_encounter_patient_location_search_test
      test from: :us_core_v600_ballot_encounter_read_test
      test from: :us_core_v600_ballot_encounter_provenance_revinclude_search_test
      test from: :us_core_v600_ballot_encounter_validation_test
      test from: :us_core_v600_ballot_encounter_must_support_test
      test from: :us_core_v600_ballot_encounter_reference_resolution_test
    end
  end
end
