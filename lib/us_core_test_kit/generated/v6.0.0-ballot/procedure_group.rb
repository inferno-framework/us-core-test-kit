...
read succeeds.
      ...
      id :us_core_v600_ballot_procedure
      run_as_group
      ...
      test from: :us_core_v600_ballot_procedure_patient_search_test
      test from: :us_core_v600_ballot_procedure_patient_status_search_test
      test from: :us_core_v600_ballot_procedure_patient_code_date_search_test
      test from: :us_core_v600_ballot_procedure_patient_date_search_test
      test from: :us_core_v600_ballot_procedure_read_test
      test from: :us_core_v600_ballot_procedure_provenance_revinclude_search_test
      test from: :us_core_v600_ballot_procedure_validation_test
      test from: :us_core_v600_ballot_procedure_must_support_test
      test from: :us_core_v600_ballot_procedure_reference_resolution_test
    end
  end
end
