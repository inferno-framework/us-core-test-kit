...
read succeeds.
      ...
      id :us_core_v600_ballot_service_request
      run_as_group
      ...
      test from: :us_core_v600_ballot_service_request_patient_search_test
      test from: :us_core_v600_ballot_service_request__id_search_test
      test from: :us_core_v600_ballot_service_request_patient_code_authored_search_test
      test from: :us_core_v600_ballot_service_request_patient_category_authored_search_test
      test from: :us_core_v600_ballot_service_request_patient_code_search_test
      test from: :us_core_v600_ballot_service_request_patient_status_search_test
      test from: :us_core_v600_ballot_service_request_patient_category_search_test
      test from: :us_core_v600_ballot_service_request_read_test
      test from: :us_core_v600_ballot_service_request_provenance_revinclude_search_test
      test from: :us_core_v600_ballot_service_request_validation_test
      test from: :us_core_v600_ballot_service_request_must_support_test
      test from: :us_core_v600_ballot_service_request_reference_resolution_test
    end
  end
end
