...
read succeeds.
      ...
      test from: :us_core_v800_procedure_patient_search_test
      test from: :us_core_v800_procedure_patient_status_search_test
      test from: :us_core_v800_procedure_patient_date_search_test
      test from: :us_core_v800_procedure_patient_code_date_search_test
      test from: :us_core_v800_procedure_read_test
      test from: :us_core_v800_procedure_provenance_revinclude_search_test
      test from: :us_core_v800_procedure_validation_test
      test from: :us_core_v800_procedure_must_support_test
      test from: :us_core_v800_procedure_reference_resolution_test
    end
  end
end
