...
module USCoreTestKit
  module USCoreV800
    class ObservationAdiDocumentationValidationTest < Inferno::Test
      include USCoreTestKit::ValidationTest

      id :us_core_v800_observation_adi_documentation_validation_test
      title 'Observation resources returned during previous tests conform to the US Core Observation ADI Documentation Profile'
      description %(
This test verifies resources returned from the first search conform to
the [US Core Observation ADI Documentation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-adi-documentation).
...
fail if their code/system are not found in the valueset.
      ...
      def scratch_resources
        scratch[:observation_adi_documentation_resources] ||= {}
      end
