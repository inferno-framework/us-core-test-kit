...
read succeeds.
      ...
      id :us_core_v800_practitioner_role
      run_as_group
      optional
      ...
      test from: :us_core_v800_practitioner_role_read_test
      test from: :us_core_v800_practitioner_role_practitioner_search_test
      test from: :us_core_v800_practitioner_role_specialty_search_test
      test from: :us_core_v800_practitioner_role_validation_test
      test from: :us_core_v800_practitioner_role_must_support_test
      test from: :us_core_v800_practitioner_role_reference_resolution_test
    end
  end
end
