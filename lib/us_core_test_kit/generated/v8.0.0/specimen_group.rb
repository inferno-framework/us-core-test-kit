...
read succeeds.
      ...
      test from: :us_core_v800_specimen_read_test
      test from: :us_core_v800_specimen_patient_search_test
      test from: :us_core_v800_specimen__id_search_test
      test from: :us_core_v800_specimen_validation_test
      test from: :us_core_v800_specimen_must_support_test
      test from: :us_core_v800_specimen_reference_resolution_test
    end
  end
end
