...
module USCoreTestKit
  module USCoreV800
    class TreatmentInterventionPreferencePatientCategorySearchTest < Inferno::Test
...
[US Core Server CapabilityStatement](http://hl7.org/fhir/us/core/STU8/CapabilityStatement-us-core-server.html)
      ...
      id :us_core_v800_treatment_intervention_preference_patient_category_search_test
      input :patient_ids,
        title: 'Patient IDs',
