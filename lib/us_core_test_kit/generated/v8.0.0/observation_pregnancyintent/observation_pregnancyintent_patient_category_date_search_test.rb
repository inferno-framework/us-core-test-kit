...
module USCoreTestKit
  module USCoreV800
    class ObservationPregnancyintentPatientCategoryDateSearchTest < Inferno::Test
...
[US Core Server CapabilityStatement](http://hl7.org/fhir/us/core/STU8/CapabilityStatement-us-core-server.html)
      ...
      id :us_core_v800_observation_pregnancyintent_patient_category_date_search_test
      input :patient_ids,
        title: 'Patient IDs',
