...
read succeeds.
      ...
      test from: :us_core_v800_care_plan_validation_test
      test from: :us_core_v800_care_plan_must_support_test
      test from: :us_core_v800_care_plan_reference_resolution_test
    end
  end
end
