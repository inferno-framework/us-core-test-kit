...
module USCoreTestKit
  module USCoreV800
    class SmartGranularScopes2Group < Inferno::TestGroup
      id :us_core_v800_smart_granular_scopes_2
...
* `Observation.rs?category=http://hl7.org/fhir/us/core/CodeSystem/us-core-category|sdoh`
      ...
      group from: :us_core_v800_condition_granular_scope_2_group
      group from: :us_core_v800_observation_granular_scope_2_group
    end
  end
end
