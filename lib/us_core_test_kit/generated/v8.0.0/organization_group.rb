...
read succeeds.
      ...
      test from: :us_core_v800_organization_read_test
      test from: :us_core_v800_organization_address_search_test
      test from: :us_core_v800_organization_name_search_test
      test from: :us_core_v800_organization_validation_test
      test from: :us_core_v800_organization_must_support_test
    end
  end
end
