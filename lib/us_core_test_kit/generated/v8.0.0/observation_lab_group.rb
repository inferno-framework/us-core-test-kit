...
read succeeds.
      ...
      id :us_core_v800_observation_lab
      run_as_group
      ...
      test from: :us_core_v800_observation_lab_must_support_test
      test from: :us_core_v800_observation_lab_reference_resolution_test
    end
  end
end
