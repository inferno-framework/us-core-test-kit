...
module USCoreTestKit
  module USCoreV800
    class RelatedPersonProvenanceRevincludeSearchTest < Inferno::Test
      ...
      title 'Server returns Provenance resources from RelatedPerson search by patient + revInclude:Provenance:target'
      description %(
      ...
      id :us_core_v800_related_person_provenance_revinclude_search_test
  
      verifies_requirements 'hl7.fhir.us.core_8.0.0@506'
