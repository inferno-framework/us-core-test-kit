...
read succeeds.
      ...
      test from: :us_core_v800_encounter_class_patient_search_test
      test from: :us_core_v800_encounter_read_test
      test from: :us_core_v800_encounter_provenance_revinclude_search_test
      test from: :us_core_v800_encounter_validation_test
      test from: :us_core_v800_encounter_must_support_test
      test from: :us_core_v800_encounter_reference_resolution_test
      test from: :us_core_v800_interpreter_required_extension_test
    end
  end
end
