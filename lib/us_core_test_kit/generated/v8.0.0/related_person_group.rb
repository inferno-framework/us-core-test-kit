...
read succeeds.
      ...
      id :us_core_v800_related_person
      run_as_group
      ...
      test from: :us_core_v800_related_person_read_test
      test from: :us_core_v800_related_person_patient_search_test
      test from: :us_core_v800_related_person__id_search_test
      test from: :us_core_v800_related_person_name_search_test
      test from: :us_core_v800_related_person_patient_name_search_test
      test from: :us_core_v800_related_person_provenance_revinclude_search_test
      test from: :us_core_v800_related_person_validation_test
      test from: :us_core_v800_related_person_must_support_test
      test from: :us_core_v800_related_person_reference_resolution_test
    end
  end
end
