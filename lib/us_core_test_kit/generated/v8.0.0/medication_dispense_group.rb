...
read succeeds.
      ...
      id :us_core_v800_medication_dispense
      run_as_group
      ...
      test from: :us_core_v800_medication_dispense_must_support_test
      test from: :us_core_v800_medication_dispense_reference_resolution_test
    end
  end
end
