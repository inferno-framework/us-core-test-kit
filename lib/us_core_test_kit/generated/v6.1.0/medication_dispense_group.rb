...
read succeeds.
      ...
      test from: :us_core_v610_medication_dispense_patient_search_test
      test from: :us_core_v610_medication_dispense_patient_status_type_search_test
      test from: :us_core_v610_medication_dispense_patient_status_search_test
      test from: :us_core_v610_medication_dispense_read_test
      test from: :us_core_v610_medication_dispense_provenance_revinclude_search_test
      test from: :us_core_v610_medication_dispense_validation_test
      test from: :us_core_v610_medication_dispense_must_support_test
      test from: :us_core_v610_medication_dispense_reference_resolution_test
    end
  end
end
