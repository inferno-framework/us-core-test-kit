...
* `DiagnosticReport.rs?category=http://terminology.hl7.org/CodeSystem/v2-0074|LAB`
      ...
      id :us_core_v610_diagnostic_report_granular_scope_2_group
      run_as_group
      ...
      test from: :us_core_v610_DiagnosticReport_patient_category_granular_scope_test
      test from: :us_core_v610_DiagnosticReport_patient_granular_scope_test
      test from: :us_core_v610_DiagnosticReport_patient_code_date_granular_scope_test
      test from: :us_core_v610_DiagnosticReport_patient_status_granular_scope_test
      test from: :us_core_v610_DiagnosticReport_patient_category_date_granular_scope_test
      test from: :us_core_v610_DiagnosticReport_patient_code_granular_scope_test
    end
  end
end
