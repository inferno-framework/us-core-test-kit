...
read succeeds.
      ...
      test from: :us_core_v610_bmi_patient_code_search_test
      test from: :us_core_v610_bmi_patient_code_date_search_test
      test from: :us_core_v610_bmi_patient_category_status_search_test
      test from: :us_core_v610_bmi_patient_category_date_search_test
      test from: :us_core_v610_bmi_patient_category_search_test
      test from: :us_core_v610_bmi_read_test
      test from: :us_core_v610_bmi_provenance_revinclude_search_test
      test from: :us_core_v610_bmi_validation_test
      test from: :us_core_v610_bmi_must_support_test
      test from: :us_core_v610_bmi_reference_resolution_test
    end
  end
end
