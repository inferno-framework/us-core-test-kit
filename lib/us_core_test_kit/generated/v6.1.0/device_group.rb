...
read succeeds.
      ...
      test from: :us_core_v610_device_patient_search_test
      test from: :us_core_v610_device_patient_type_search_test
      test from: :us_core_v610_device_patient_status_search_test
      test from: :us_core_v610_device_read_test
      test from: :us_core_v610_device_provenance_revinclude_search_test
      test from: :us_core_v610_device_validation_test
      test from: :us_core_v610_device_must_support_test
      test from: :us_core_v610_device_reference_resolution_test
    end
  end
end
