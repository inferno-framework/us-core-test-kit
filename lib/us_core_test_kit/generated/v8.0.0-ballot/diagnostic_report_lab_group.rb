...
require_relative 'diagnostic_report_lab/diagnostic_report_lab_patient_category_lastupdated_search_test'
...
The US Core DiagnosticReport for Laboratory Results Reporting sequence verifies that the system under test is
able to provide correct responses for DiagnosticReport queries. These queries
must contain resources conforming to the US Core DiagnosticReport Profile for Laboratory Results Reporting as
...
the [US Core DiagnosticReport Profile for Laboratory Results Reporting](http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v800_ballot_diagnostic_report_lab
      run_as_group
      ...
      test from: :us_core_v800_ballot_diagnostic_report_lab_patient_category_search_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_patient_search_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_patient_status_search_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_patient_code_date_search_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_patient_category_date_search_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_patient_code_search_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_patient_category__lastUpdated_search_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_read_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_provenance_revinclude_search_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_validation_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_must_support_test
      test from: :us_core_v800_ballot_diagnostic_report_lab_reference_resolution_test
    end
  end
end
