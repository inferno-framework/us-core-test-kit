...
* `Observation.rs?category=http://hl7.org/fhir/us/core/CodeSystem/us-core-category|sdoh`
      ...
      id :us_core_v800_ballot_observation_granular_scope_2_group
      run_as_group

    
      test from: :us_core_v800_ballot_Observation_patient_category_granular_scope_search_test
      test from: :us_core_v800_ballot_Observation_patient_code_date_granular_scope_search_test
      test from: :us_core_v800_ballot_Observation_patient_category_date_granular_scope_search_test
      test from: :us_core_v800_ballot_Observation_patient_code_granular_scope_search_test
      test from: :us_core_v800_ballot_Observation_patient_category__lastUpdated_granular_scope_search_test
      test from: :us_core_v800_ballot_Observation_patient_category_status_granular_scope_search_test
      test from: :us_core_v800_ballot_Observation_granular_scope_read_test
    end
  end
end
