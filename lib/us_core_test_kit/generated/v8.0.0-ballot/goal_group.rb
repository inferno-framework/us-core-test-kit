...
read succeeds.
      ...
      test from: :us_core_v800_ballot_goal_patient_search_test
      test from: :us_core_v800_ballot_goal_patient_target_date_search_test
      test from: :us_core_v800_ballot_goal_patient_lifecycle_status_search_test
      test from: :us_core_v800_ballot_goal_patient_description_search_test
      test from: :us_core_v800_ballot_goal_read_test
      test from: :us_core_v800_ballot_goal_provenance_revinclude_search_test
      test from: :us_core_v800_ballot_goal_validation_test
      test from: :us_core_v800_ballot_goal_must_support_test
      test from: :us_core_v800_ballot_goal_reference_resolution_test
    end
  end
end
