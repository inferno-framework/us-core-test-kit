...
require_relative 'pediatric_weight_for_height/pediatric_weight_for_height_patient_category_lastupdated_search_test'
...
the [US Core Pediatric Weight for Height Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v800_ballot_pediatric_weight_for_height
      run_as_group

      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'pediatric_weight_for_height', 'metadata.yml'), aliases: true))
      end
  
      test from: :us_core_v800_ballot_pediatric_weight_for_height_patient_code_search_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_patient_code_date_search_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_patient_category_date_search_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_patient_category__lastUpdated_search_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_patient_category_search_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_patient_category_status_search_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_read_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_provenance_revinclude_search_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_validation_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_must_support_test
      test from: :us_core_v800_ballot_pediatric_weight_for_height_reference_resolution_test
    end
  end
end
