...
module USCoreTestKit
  module USCoreV800_BALLOT
    class ObservationPatientCategoryLastupdatedGranularScopeSearchTest < Inferno::Test
      include USCoreTestKit::SearchTest
      include USCoreTestKit::GranularScopeSearchTest

      title 'Server filters results for Observation search by patient + category + _lastUpdated based on granular scopes'
      description %(
...
filtered based on the granted granular scopes.
      ...
      id :us_core_v800_ballot_Observation_patient_category__lastUpdated_granular_scope_search_test
      optional
