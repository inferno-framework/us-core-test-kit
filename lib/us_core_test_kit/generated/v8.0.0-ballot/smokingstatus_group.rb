...
require_relative 'smokingstatus/smokingstatus_patient_category_lastupdated_search_test'
...
The US Core Observation Smoking Status sequence verifies that the system under test is
able to provide correct responses for Observation queries. These queries
must contain resources conforming to the US Core Smoking Status Observation Profile as
...
the [US Core Smoking Status Observation Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-smokingstatus). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v800_ballot_smokingstatus
      run_as_group
      ...
      test from: :us_core_v800_ballot_smokingstatus_patient_code_search_test
      test from: :us_core_v800_ballot_smokingstatus_patient_code_date_search_test
      test from: :us_core_v800_ballot_smokingstatus_patient_category_date_search_test
      test from: :us_core_v800_ballot_smokingstatus_patient_category__lastUpdated_search_test
      test from: :us_core_v800_ballot_smokingstatus_patient_category_search_test
      test from: :us_core_v800_ballot_smokingstatus_patient_category_status_search_test
      test from: :us_core_v800_ballot_smokingstatus_read_test
      test from: :us_core_v800_ballot_smokingstatus_provenance_revinclude_search_test
      test from: :us_core_v800_ballot_smokingstatus_validation_test
      test from: :us_core_v800_ballot_smokingstatus_must_support_test
      test from: :us_core_v800_ballot_smokingstatus_reference_resolution_test
    end
  end
end
