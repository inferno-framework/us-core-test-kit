...
read succeeds.
      ...
      id :us_core_v800_ballot_location
      run_as_group
      ...
      test from: :us_core_v800_ballot_location_read_test
      test from: :us_core_v800_ballot_location_address_search_test
      test from: :us_core_v800_ballot_location_address_city_search_test
      test from: :us_core_v800_ballot_location_address_postalcode_search_test
      test from: :us_core_v800_ballot_location_address_state_search_test
      test from: :us_core_v800_ballot_location_name_search_test
      test from: :us_core_v800_ballot_location_validation_test
      test from: :us_core_v800_ballot_location_must_support_test
      test from: :us_core_v800_ballot_location_reference_resolution_test
    end
  end
end
