...
module USCoreTestKit
  module USCoreV800_BALLOT
    class SmartGranularScopes1Group < Inferno::TestGroup
      id :us_core_v800_ballot_smart_granular_scopes_1
...
* `Observation.rs?category=http://terminology.hl7.org/CodeSystem/observation-category|social-history`
      ...
      group from: :us_core_v800_ballot_condition_granular_scope_1_group
      group from: :us_core_v800_ballot_observation_granular_scope_1_group
    end
  end
end
