...
read succeeds.
      ...
      id :us_core_v800_ballot_specimen
      run_as_group
      ...
      test from: :us_core_v800_ballot_specimen_read_test
      test from: :us_core_v800_ballot_specimen_patient_search_test
      test from: :us_core_v800_ballot_specimen__id_search_test
      test from: :us_core_v800_ballot_specimen_validation_test
      test from: :us_core_v800_ballot_specimen_must_support_test
      test from: :us_core_v800_ballot_specimen_reference_resolution_test
    end
  end
end
