...
read succeeds.
      ...
      id :us_core_v800_ballot_patient
      run_as_group
      ...
      test from: :us_core_v800_ballot_patient__id_search_test
      test from: :us_core_v800_ballot_patient_identifier_search_test
      test from: :us_core_v800_ballot_patient_name_search_test
      test from: :us_core_v800_ballot_patient_family_gender_search_test
      test from: :us_core_v800_ballot_patient_birthdate_name_search_test
      test from: :us_core_v800_ballot_patient_death_date_family_search_test
      test from: :us_core_v800_ballot_patient_gender_name_search_test
      test from: :us_core_v800_ballot_patient_birthdate_family_search_test
      test from: :us_core_v800_ballot_patient_read_test
      test from: :us_core_v800_ballot_patient_provenance_revinclude_search_test
      test from: :us_core_v800_ballot_patient_validation_test
      test from: :us_core_v800_ballot_patient_must_support_test
    end
  end
end
