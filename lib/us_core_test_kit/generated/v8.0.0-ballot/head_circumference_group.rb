...
require_relative 'head_circumference/head_circumference_patient_category_lastupdated_search_test'
...
The US Core Observation Head Circumference sequence verifies that the system under test is
...
read succeeds.
      ...
      id :us_core_v800_ballot_head_circumference
      run_as_group

      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'head_circumference', 'metadata.yml'), aliases: true))
      end
  
      test from: :us_core_v800_ballot_head_circumference_patient_code_search_test
      test from: :us_core_v800_ballot_head_circumference_patient_code_date_search_test
      test from: :us_core_v800_ballot_head_circumference_patient_category_date_search_test
      test from: :us_core_v800_ballot_head_circumference_patient_category__lastUpdated_search_test
      test from: :us_core_v800_ballot_head_circumference_patient_category_search_test
      test from: :us_core_v800_ballot_head_circumference_patient_category_status_search_test
      test from: :us_core_v800_ballot_head_circumference_read_test
      test from: :us_core_v800_ballot_head_circumference_provenance_revinclude_search_test
      test from: :us_core_v800_ballot_head_circumference_validation_test
      test from: :us_core_v800_ballot_head_circumference_must_support_test
      test from: :us_core_v800_ballot_head_circumference_reference_resolution_test
    end
  end
end
