...
require_relative '../../custom_groups/v8.0.0-ballot/screening_assessment_group'
require_relative '../../provenance_validator'
require_relative '../../us_core_options'
require_relative '../../custom_groups/v8.0.0-ballot/smart_app_launch_group'
require_relative '../../custom_groups/v8.0.0-ballot/smart_app_launch_stu2_2_group'
...
module USCoreTestKit
  module USCoreV800_BALLOT
    class USCoreTestSuite < Inferno::TestSuite
      ...
      id :us_core_v800_ballot

      fhir_resource_validator do
        igs 'hl7.fhir.us.core#8.0.0-ballot'
      ...
      group from: :us_core_v800_ballot_smart_app_launch,
            required_suite_options: USCoreOptions::SMART_1_REQUIREMENT
      group from: :us_core_v800_ballot_smart_app_launch,
            required_suite_options: USCoreOptions::SMART_2_REQUIREMENT,
            id: :us_core_v800_ballot_smart_app_launch_stu2
      group from: :us_core_v800_ballot_smart_app_launch_stu2_2,
      ...
      group do
        ...
        id :us_core_v800_ballot_fhir_api
        ...
        group from: :us_core_v800_ballot_capability_statement
      
        group from: :us_core_v800_ballot_patient
        group from: :us_core_v800_ballot_allergy_intolerance
        group from: :us_core_v800_ballot_care_plan
        group from: :us_core_v800_ballot_care_team
        group from: :us_core_v800_ballot_condition_encounter_diagnosis
        group from: :us_core_v800_ballot_condition_problems_health_concerns
        group from: :us_core_v800_ballot_coverage
        group from: :us_core_v800_ballot_device
        group from: :us_core_v800_ballot_diagnostic_report_note
        group from: :us_core_v800_ballot_diagnostic_report_lab
        group from: :us_core_v800_ballot_document_reference
        group from: :us_core_v800_ballot_encounter
        group from: :us_core_v800_ballot_goal
        group from: :us_core_v800_ballot_immunization
        group from: :us_core_v800_ballot_medication_dispense
        group from: :us_core_v800_ballot_medication_request
        group from: :us_core_v800_ballot_observation_lab
        group from: :us_core_v800_ballot_observation_pregnancystatus
        group from: :us_core_v800_ballot_observation_pregnancyintent
        group from: :us_core_v800_ballot_observation_occupation
        group from: :us_core_v800_ballot_respiratory_rate
        group from: :us_core_v800_ballot_simple_observation
        group from: :us_core_v800_ballot_treatment_intervention_preference
        group from: :us_core_v800_ballot_care_experience_preference
        group from: :us_core_v800_ballot_heart_rate
        group from: :us_core_v800_ballot_body_temperature
        group from: :us_core_v800_ballot_pediatric_weight_for_height
        group from: :us_core_v800_ballot_pulse_oximetry
        group from: :us_core_v800_ballot_smokingstatus
        group from: :us_core_v800_ballot_observation_sexual_orientation
        group from: :us_core_v800_ballot_head_circumference
        group from: :us_core_v800_ballot_body_height
        group from: :us_core_v800_ballot_bmi
        group from: :us_core_v800_ballot_observation_screening_assessment
        group from: :us_core_v800_ballot_average_blood_pressure
        group from: :us_core_v800_ballot_blood_pressure
        group from: :us_core_v800_ballot_observation_clinical_result
        group from: :us_core_v800_ballot_pediatric_bmi_for_age
        group from: :us_core_v800_ballot_head_circumference_percentile
        group from: :us_core_v800_ballot_body_weight
        group from: :us_core_v800_ballot_procedure
        group from: :us_core_v800_ballot_questionnaire_response
        group from: :us_core_v800_ballot_service_request
        group from: :us_core_v800_ballot_location
        group from: :us_core_v800_ballot_organization
        group from: :us_core_v800_ballot_practitioner
        group from: :us_core_v800_ballot_practitioner_role
      ...
      group from: :us_core_v800_ballot_smart_granular_scopes,
            required_suite_options: USCoreOptions::SMART_2_REQUIREMENT
      group from: :us_core_v800_ballot_smart_granular_scopes,
            id: :us_core_v800_ballot_smart_granular_scopes_stu2_2,
            required_suite_options: USCoreOptions::SMART_2_2_REQUIREMENT
