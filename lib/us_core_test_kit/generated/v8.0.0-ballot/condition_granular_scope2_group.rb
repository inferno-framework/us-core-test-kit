...
* `Condition.rs?category=http://terminology.hl7.org/CodeSystem/condition-category|problem-list-item`
      ...
      id :us_core_v800_ballot_condition_granular_scope_2_group
      run_as_group

    
      test from: :us_core_v800_ballot_Condition_patient_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_onset_date_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient__lastUpdated_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_category_encounter_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_category_clinical_status_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_recorded_date_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_asserted_date_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_abatement_date_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_code_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_category_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_patient_clinical_status_granular_scope_search_test
      test from: :us_core_v800_ballot_Condition_granular_scope_read_test
    end
  end
end
