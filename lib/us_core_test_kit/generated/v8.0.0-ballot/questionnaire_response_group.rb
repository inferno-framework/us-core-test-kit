...
read succeeds.
      ...
      id :us_core_v800_ballot_questionnaire_response
      run_as_group
      optional
      ...
      test from: :us_core_v800_ballot_questionnaire_response_patient_search_test
      test from: :us_core_v800_ballot_questionnaire_response__id_search_test
      test from: :us_core_v800_ballot_questionnaire_response_patient_status_search_test
      test from: :us_core_v800_ballot_questionnaire_response_patient_questionnaire_search_test
      test from: :us_core_v800_ballot_questionnaire_response_patient_authored_search_test
      test from: :us_core_v800_ballot_questionnaire_response_read_test
      test from: :us_core_v800_ballot_questionnaire_response_provenance_revinclude_search_test
      test from: :us_core_v800_ballot_questionnaire_response_validation_test
      test from: :us_core_v800_ballot_questionnaire_response_must_support_test
      test from: :us_core_v800_ballot_questionnaire_response_reference_resolution_test
    end
  end
end
