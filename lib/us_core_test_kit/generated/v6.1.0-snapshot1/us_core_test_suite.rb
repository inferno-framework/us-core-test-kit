...
require_relative '../../custom_groups/v6.1.0-snapshot1/capability_statement_group'
...
module USCoreTestKit
  module USCoreV610_SNAPSHOT1
    class USCoreTestSuite < Inferno::TestSuite
      title 'US Core v6.1.0-snapshot1'
      description %(
      ...
      validator do
        url ENV.fetch('V610_SNAPSHOT1_VALIDATOR_URL', 'http://validator_service:4567')
      ...
      group from: :us_core_v610_snapshot1_capability_statement
  
      group from: :us_core_v610_snapshot1_patient
      group from: :us_core_v610_snapshot1_allergy_intolerance
      group from: :us_core_v610_snapshot1_care_plan
      group from: :us_core_v610_snapshot1_care_team
      group from: :us_core_v610_snapshot1_condition_encounter_diagnosis
      group from: :us_core_v610_snapshot1_condition_problems_health_concerns
      group from: :us_core_v610_snapshot1_coverage
      group from: :us_core_v610_snapshot1_device
      group from: :us_core_v610_snapshot1_diagnostic_report_note
      group from: :us_core_v610_snapshot1_diagnostic_report_lab
      group from: :us_core_v610_snapshot1_document_reference
      group from: :us_core_v610_snapshot1_encounter
      group from: :us_core_v610_snapshot1_goal
      group from: :us_core_v610_snapshot1_immunization
      group from: :us_core_v610_snapshot1_medication_dispense
      group from: :us_core_v610_snapshot1_medication_request
      group from: :us_core_v610_snapshot1_observation_lab
      group from: :us_core_v610_snapshot1_observation_pregnancystatus
      group from: :us_core_v610_snapshot1_observation_pregnancyintent
      group from: :us_core_v610_snapshot1_observation_occupation
      group from: :us_core_v610_snapshot1_respiratory_rate
      group from: :us_core_v610_snapshot1_simple_observation
      group from: :us_core_v610_snapshot1_heart_rate
      group from: :us_core_v610_snapshot1_body_temperature
      group from: :us_core_v610_snapshot1_pediatric_weight_for_height
      group from: :us_core_v610_snapshot1_pulse_oximetry
      group from: :us_core_v610_snapshot1_smokingstatus
      group from: :us_core_v610_snapshot1_observation_sexual_orientation
      group from: :us_core_v610_snapshot1_head_circumference
      group from: :us_core_v610_snapshot1_body_height
      group from: :us_core_v610_snapshot1_bmi
      group from: :us_core_v610_snapshot1_observation_screening_assessment
      group from: :us_core_v610_snapshot1_blood_pressure
      group from: :us_core_v610_snapshot1_observation_clinical_result
      group from: :us_core_v610_snapshot1_pediatric_bmi_for_age
      group from: :us_core_v610_snapshot1_head_circumference_percentile
      group from: :us_core_v610_snapshot1_body_weight
      group from: :us_core_v610_snapshot1_procedure
      group from: :us_core_v610_snapshot1_questionnaire_response
      group from: :us_core_v610_snapshot1_service_request
      group from: :us_core_v610_snapshot1_organization
      group from: :us_core_v610_snapshot1_practitioner
      group from: :us_core_v610_snapshot1_provenance
      group from: :us_core_v610_snapshot1_related_person
      group from: :us_core_v610_snapshot1_specimen
