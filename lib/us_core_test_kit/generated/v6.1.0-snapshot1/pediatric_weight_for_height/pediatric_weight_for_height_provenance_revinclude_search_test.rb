...
module USCoreTestKit
  module USCoreV610_SNAPSHOT1
    class PediatricWeightForHeightProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v610_snapshot1_pediatric_weight_for_height_provenance_revinclude_search_test
