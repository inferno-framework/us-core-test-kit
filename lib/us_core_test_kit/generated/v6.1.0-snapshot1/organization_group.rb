...
The US Core Organization sequence verifies that the system under test is
able to provide correct responses for Organization queries. These queries
must contain resources conforming to the US Core Organization Profile as
...
the [US Core Organization Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-organization). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_organization
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_organization_read_test
      test from: :us_core_v610_snapshot1_organization_name_search_test
      test from: :us_core_v610_snapshot1_organization_address_search_test
      test from: :us_core_v610_snapshot1_organization_validation_test
      test from: :us_core_v610_snapshot1_organization_must_support_test
    end
  end
end
