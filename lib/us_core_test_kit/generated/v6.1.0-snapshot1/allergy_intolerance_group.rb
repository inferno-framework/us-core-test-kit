...
read succeeds.
      ...
      id :us_core_v610_snapshot1_allergy_intolerance
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_allergy_intolerance_patient_search_test
      test from: :us_core_v610_snapshot1_allergy_intolerance_patient_clinical_status_search_test
      test from: :us_core_v610_snapshot1_allergy_intolerance_read_test
      test from: :us_core_v610_snapshot1_allergy_intolerance_provenance_revinclude_search_test
      test from: :us_core_v610_snapshot1_allergy_intolerance_validation_test
      test from: :us_core_v610_snapshot1_allergy_intolerance_must_support_test
      test from: :us_core_v610_snapshot1_allergy_intolerance_reference_resolution_test
    end
  end
end
