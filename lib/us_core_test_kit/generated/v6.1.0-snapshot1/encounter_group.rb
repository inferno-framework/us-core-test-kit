...
The US Core Encounter sequence verifies that the system under test is
able to provide correct responses for Encounter queries. These queries
must contain resources conforming to the US Core Encounter Profile as
...
the [US Core Encounter Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-encounter). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_encounter
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_encounter_patient_search_test
      test from: :us_core_v610_snapshot1_encounter__id_search_test
      test from: :us_core_v610_snapshot1_encounter_identifier_search_test
      test from: :us_core_v610_snapshot1_encounter_patient_type_search_test
      test from: :us_core_v610_snapshot1_encounter_class_patient_search_test
      test from: :us_core_v610_snapshot1_encounter_patient_status_search_test
      test from: :us_core_v610_snapshot1_encounter_date_patient_search_test
      test from: :us_core_v610_snapshot1_encounter_patient_location_search_test
      test from: :us_core_v610_snapshot1_encounter_patient_discharge_disposition_search_test
      test from: :us_core_v610_snapshot1_encounter_read_test
      test from: :us_core_v610_snapshot1_encounter_provenance_revinclude_search_test
      test from: :us_core_v610_snapshot1_encounter_validation_test
      test from: :us_core_v610_snapshot1_encounter_must_support_test
      test from: :us_core_v610_snapshot1_encounter_reference_resolution_test
    end
  end
end
