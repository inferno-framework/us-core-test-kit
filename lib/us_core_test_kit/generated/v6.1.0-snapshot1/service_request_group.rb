...
The US Core ServiceRequest sequence verifies that the system under test is
able to provide correct responses for ServiceRequest queries. These queries
must contain resources conforming to the US Core ServiceRequest Profile as
...
the [US Core ServiceRequest Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-servicerequest). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_service_request
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_service_request_patient_search_test
      test from: :us_core_v610_snapshot1_service_request__id_search_test
      test from: :us_core_v610_snapshot1_service_request_patient_category_authored_search_test
      test from: :us_core_v610_snapshot1_service_request_patient_status_search_test
      test from: :us_core_v610_snapshot1_service_request_patient_category_search_test
      test from: :us_core_v610_snapshot1_service_request_patient_code_authored_search_test
      test from: :us_core_v610_snapshot1_service_request_patient_code_search_test
      test from: :us_core_v610_snapshot1_service_request_read_test
      test from: :us_core_v610_snapshot1_service_request_provenance_revinclude_search_test
      test from: :us_core_v610_snapshot1_service_request_validation_test
      test from: :us_core_v610_snapshot1_service_request_must_support_test
      test from: :us_core_v610_snapshot1_service_request_reference_resolution_test
    end
  end
end
