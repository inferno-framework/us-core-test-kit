...
The US Core Implantable Device sequence verifies that the system under test is
able to provide correct responses for Device queries. These queries
must contain resources conforming to the US Core Implantable Device Profile as
...
the [US Core Implantable Device Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-implantable-device). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_device
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_device_patient_search_test
      test from: :us_core_v610_snapshot1_device_patient_type_search_test
      test from: :us_core_v610_snapshot1_device_patient_status_search_test
      test from: :us_core_v610_snapshot1_device_read_test
      test from: :us_core_v610_snapshot1_device_provenance_revinclude_search_test
      test from: :us_core_v610_snapshot1_device_validation_test
      test from: :us_core_v610_snapshot1_device_must_support_test
      test from: :us_core_v610_snapshot1_device_reference_resolution_test
    end
  end
end
