...
Specimen resources and save them for subsequent tests. Each of
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_specimen
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_specimen_read_test
      test from: :us_core_v610_snapshot1_specimen_patient_search_test
      test from: :us_core_v610_snapshot1_specimen__id_search_test
      test from: :us_core_v610_snapshot1_specimen_validation_test
      test from: :us_core_v610_snapshot1_specimen_must_support_test
      test from: :us_core_v610_snapshot1_specimen_reference_resolution_test
    end
  end
end
