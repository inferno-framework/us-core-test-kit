...
The US Core DocumentReference sequence verifies that the system under test is
able to provide correct responses for DocumentReference queries. These queries
must contain resources conforming to the US Core DocumentReference Profile as
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_document_reference
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_document_reference_patient_search_test
      test from: :us_core_v610_snapshot1_document_reference__id_search_test
      test from: :us_core_v610_snapshot1_document_reference_patient_type_search_test
      test from: :us_core_v610_snapshot1_document_reference_patient_status_search_test
      test from: :us_core_v610_snapshot1_document_reference_patient_type_period_search_test
      test from: :us_core_v610_snapshot1_document_reference_patient_category_date_search_test
      test from: :us_core_v610_snapshot1_document_reference_patient_category_search_test
      test from: :us_core_v610_snapshot1_document_reference_read_test
      test from: :us_core_v610_snapshot1_document_reference_provenance_revinclude_search_test
      test from: :us_core_v610_snapshot1_document_reference_validation_test
      test from: :us_core_v610_snapshot1_document_reference_must_support_test
      test from: :us_core_v610_snapshot1_document_reference_reference_resolution_test
