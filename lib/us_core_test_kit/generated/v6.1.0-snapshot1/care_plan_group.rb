...
module USCoreTestKit
  module USCoreV610_SNAPSHOT1
    class CarePlanGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the server capabilities required by the US Core CarePlan Profile.'
      description %(
  # Background
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_care_plan
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_care_plan_patient_category_search_test
      test from: :us_core_v610_snapshot1_care_plan_patient_category_status_search_test
      test from: :us_core_v610_snapshot1_care_plan_patient_category_status_date_search_test
      test from: :us_core_v610_snapshot1_care_plan_patient_category_date_search_test
      test from: :us_core_v610_snapshot1_care_plan_read_test
      test from: :us_core_v610_snapshot1_care_plan_provenance_revinclude_search_test
      test from: :us_core_v610_snapshot1_care_plan_validation_test
      test from: :us_core_v610_snapshot1_care_plan_must_support_test
      test from: :us_core_v610_snapshot1_care_plan_reference_resolution_test
    end
  end
end
