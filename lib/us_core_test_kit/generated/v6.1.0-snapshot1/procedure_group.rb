...
The US Core Procedure sequence verifies that the system under test is
able to provide correct responses for Procedure queries. These queries
must contain resources conforming to the US Core Procedure Profile as
...
the [US Core Procedure Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-procedure). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_procedure
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_procedure_patient_search_test
      test from: :us_core_v610_snapshot1_procedure_patient_code_date_search_test
      test from: :us_core_v610_snapshot1_procedure_patient_status_search_test
      test from: :us_core_v610_snapshot1_procedure_patient_date_search_test
      test from: :us_core_v610_snapshot1_procedure_read_test
      test from: :us_core_v610_snapshot1_procedure_provenance_revinclude_search_test
      test from: :us_core_v610_snapshot1_procedure_validation_test
      test from: :us_core_v610_snapshot1_procedure_must_support_test
      test from: :us_core_v610_snapshot1_procedure_reference_resolution_test
    end
  end
end
