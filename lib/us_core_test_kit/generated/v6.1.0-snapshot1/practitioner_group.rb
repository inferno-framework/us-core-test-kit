...
The US Core Practitioner sequence verifies that the system under test is
able to provide correct responses for Practitioner queries. These queries
must contain resources conforming to the US Core Practitioner Profile as
...
the [US Core Practitioner Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitioner). Each element is checked against
...
read succeeds.
      ...
      id :us_core_v610_snapshot1_practitioner
      run_as_group
      ...
      test from: :us_core_v610_snapshot1_practitioner_read_test
      test from: :us_core_v610_snapshot1_practitioner__id_search_test
      test from: :us_core_v610_snapshot1_practitioner_name_search_test
      test from: :us_core_v610_snapshot1_practitioner_identifier_search_test
      test from: :us_core_v610_snapshot1_practitioner_validation_test
      test from: :us_core_v610_snapshot1_practitioner_must_support_test
    end
  end
end
