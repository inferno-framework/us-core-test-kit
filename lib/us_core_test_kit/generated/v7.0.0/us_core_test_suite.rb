...
require_relative '../../custom_groups/v7.0.0/capability_statement_group'
...
require_relative '../../custom_groups/v7.0.0/smart_granular_scopes_group'
  ...
  module USCoreV700
    class USCoreTestSuite < Inferno::TestSuite
      ...
      group do
        ...
        group from: :us_core_v700_care_team
        group from: :us_core_v700_condition_encounter_diagnosis
        group from: :us_core_v700_condition_problems_health_concerns
        group from: :us_core_v700_coverage
        group from: :us_core_v700_device
        group from: :us_core_v700_diagnostic_report_note
        group from: :us_core_v700_diagnostic_report_lab
        group from: :us_core_v700_document_reference
        group from: :us_core_v700_encounter
        group from: :us_core_v700_goal
        group from: :us_core_v700_immunization
        group from: :us_core_v700_medication_dispense
        group from: :us_core_v700_medication_request
        group from: :us_core_v700_observation_lab
        group from: :us_core_v700_observation_pregnancystatus
        group from: :us_core_v700_observation_pregnancyintent
        group from: :us_core_v700_observation_occupation
        group from: :us_core_v700_respiratory_rate
        group from: :us_core_v700_simple_observation
        group from: :us_core_v700_treatment_intervention_preference
        group from: :us_core_v700_care_experience_preference
        group from: :us_core_v700_heart_rate
        group from: :us_core_v700_body_temperature
        group from: :us_core_v700_pediatric_weight_for_height
        group from: :us_core_v700_pulse_oximetry
        group from: :us_core_v700_smokingstatus
        group from: :us_core_v700_observation_sexual_orientation
        group from: :us_core_v700_head_circumference
        group from: :us_core_v700_body_height
        group from: :us_core_v700_bmi
        group from: :us_core_v700_observation_screening_assessment
        group from: :us_core_v700_average_blood_pressure
        group from: :us_core_v700_blood_pressure
        group from: :us_core_v700_observation_clinical_result
        group from: :us_core_v700_pediatric_bmi_for_age
        group from: :us_core_v700_head_circumference_percentile
        group from: :us_core_v700_body_weight
        group from: :us_core_v700_procedure
        group from: :us_core_v700_questionnaire_response
        group from: :us_core_v700_service_request
        group from: :us_core_v700_location
        group from: :us_core_v700_organization
        group from: :us_core_v700_practitioner
        group from: :us_core_v700_practitioner_role
        group from: :us_core_v700_provenance
        group from: :us_core_v700_related_person
        group from: :us_core_v700_specimen
