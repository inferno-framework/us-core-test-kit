...
read succeeds.
      ...
      test from: :us_core_v700_observation_lab_patient_category_search_test
      test from: :us_core_v700_observation_lab_patient_code_search_test
      test from: :us_core_v700_observation_lab_patient_category_date_search_test
      test from: :us_core_v700_observation_lab_patient_code_date_search_test
      test from: :us_core_v700_observation_lab_patient_category_status_search_test
      test from: :us_core_v700_observation_lab_patient_category__lastUpdated_search_test
      test from: :us_core_v700_observation_lab_read_test
      test from: :us_core_v700_observation_lab_provenance_revinclude_search_test
      test from: :us_core_v700_observation_lab_validation_test
      test from: :us_core_v700_observation_lab_must_support_test
      test from: :us_core_v700_observation_lab_reference_resolution_test
    end
  end
end
