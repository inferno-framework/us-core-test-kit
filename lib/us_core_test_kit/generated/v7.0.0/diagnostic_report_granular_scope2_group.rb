...
require_relative './granular_scope_tests/diagnostic_report/diagnostic_report_patient_category_lastupdated_granular_scope_search_test'
...
* `DiagnosticReport.rs?category=http://terminology.hl7.org/CodeSystem/v2-0074|LAB`
      ...
      id :us_core_v700_diagnostic_report_granular_scope_2_group
      run_as_group

    
      test from: :us_core_v700_DiagnosticReport_patient_category_granular_scope_search_test
      test from: :us_core_v700_DiagnosticReport_patient_granular_scope_search_test
      test from: :us_core_v700_DiagnosticReport_patient_code_granular_scope_search_test
      test from: :us_core_v700_DiagnosticReport_patient_category_date_granular_scope_search_test
      test from: :us_core_v700_DiagnosticReport_patient_code_date_granular_scope_search_test
      test from: :us_core_v700_DiagnosticReport_patient_status_granular_scope_search_test
      test from: :us_core_v700_DiagnosticReport_patient_category__lastUpdated_granular_scope_search_test
      test from: :us_core_v700_DiagnosticReport_granular_scope_read_test
    end
  end
end
