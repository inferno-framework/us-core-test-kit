...
module USCoreTestKit
  module USCoreV700
    class MedicationDispenseProvenanceRevincludeSearchTest < Inferno::Test
      ...
      title 'Server returns Provenance resources from MedicationDispense search by patient + revInclude:Provenance:target'
      description %(
      ...
      id :us_core_v700_medication_dispense_provenance_revinclude_search_test
  
      verifies_requirements 'hl7.fhir.us.core_7.0.0@500'
