...
* `ServiceRequest.rs?category=http://snomed.info/sct|387713003`
      ...
      id :us_core_v700_service_request_granular_scope_2_group
      run_as_group

    
      test from: :us_core_v700_ServiceRequest_patient_granular_scope_search_test
      test from: :us_core_v700_ServiceRequest__id_granular_scope_search_test
      test from: :us_core_v700_ServiceRequest_patient_code_granular_scope_search_test
      test from: :us_core_v700_ServiceRequest_patient_category_authored_granular_scope_search_test
      test from: :us_core_v700_ServiceRequest_patient_code_authored_granular_scope_search_test
      test from: :us_core_v700_ServiceRequest_patient_status_granular_scope_search_test
      test from: :us_core_v700_ServiceRequest_patient_category_granular_scope_search_test
      test from: :us_core_v700_ServiceRequest_granular_scope_read_test
    end
  end
end
