...
module USCoreTestKit
  module USCoreV700
    class ServiceRequestPatientStatusGranularScopeSearchTest < Inferno::Test
      include USCoreTestKit::SearchTest
      include USCoreTestKit::GranularScopeSearchTest

      title 'Server filters results for ServiceRequest search by patient + status based on granular scopes'
      description %(
...
filtered based on the granted granular scopes.
      ...
      id :us_core_v700_ServiceRequest_patient_status_granular_scope_search_test
