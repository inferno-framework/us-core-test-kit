...
read succeeds.
      ...
      id :us_core_v700_pediatric_bmi_for_age
      run_as_group
      ...
      test from: :us_core_v700_pediatric_bmi_for_age_patient_code_search_test
      test from: :us_core_v700_pediatric_bmi_for_age_patient_category_date_search_test
      test from: :us_core_v700_pediatric_bmi_for_age_patient_code_date_search_test
      test from: :us_core_v700_pediatric_bmi_for_age_patient_category_status_search_test
      test from: :us_core_v700_pediatric_bmi_for_age_patient_category__lastUpdated_search_test
      test from: :us_core_v700_pediatric_bmi_for_age_patient_category_search_test
      test from: :us_core_v700_pediatric_bmi_for_age_read_test
      test from: :us_core_v700_pediatric_bmi_for_age_provenance_revinclude_search_test
      test from: :us_core_v700_pediatric_bmi_for_age_validation_test
      test from: :us_core_v700_pediatric_bmi_for_age_must_support_test
      test from: :us_core_v700_pediatric_bmi_for_age_reference_resolution_test
    end
  end
end
