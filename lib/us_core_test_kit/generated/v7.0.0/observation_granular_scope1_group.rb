...
* `Observation.rs?category=http://terminology.hl7.org/CodeSystem/observation-category|social-history`
      ...
      id :us_core_v700_observation_granular_scope_1_group
      run_as_group

    
      test from: :us_core_v700_Observation_patient_category_granular_scope_search_test
      test from: :us_core_v700_Observation_patient_code_granular_scope_search_test
      test from: :us_core_v700_Observation_patient_category_date_granular_scope_search_test
      test from: :us_core_v700_Observation_patient_code_date_granular_scope_search_test
      test from: :us_core_v700_Observation_patient_category_status_granular_scope_search_test
      test from: :us_core_v700_Observation_patient_category__lastUpdated_granular_scope_search_test
      test from: :us_core_v700_Observation_granular_scope_read_test
    end
  end
end
