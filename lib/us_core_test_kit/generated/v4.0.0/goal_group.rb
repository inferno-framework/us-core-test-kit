...
read succeeds.
      ...
      test from: :us_core_v400_goal_patient_search_test
      test from: :us_core_v400_goal_patient_lifecycle_status_search_test
      test from: :us_core_v400_goal_patient_target_date_search_test
      test from: :us_core_v400_goal_read_test
      test from: :us_core_v400_goal_provenance_revinclude_search_test
      test from: :us_core_v400_goal_validation_test
      test from: :us_core_v400_goal_must_support_test
      test from: :us_core_v400_goal_reference_resolution_test
    end
  end
end
