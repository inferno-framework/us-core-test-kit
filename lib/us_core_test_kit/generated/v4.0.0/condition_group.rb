...
The US Core Condition sequence verifies that the system under test is
able to provide correct responses for Condition queries. These queries
must contain resources conforming to the US Core Condition Profile as
...
the [US Core Condition Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-condition). Each element is checked against
...
read each reference found and will fail if any attempted read fails.
      ...
      test from: :us_core_v400_condition_patient_search_test
      test from: :us_core_v400_condition_patient_code_search_test
      test from: :us_core_v400_condition_patient_onset_date_search_test
      test from: :us_core_v400_condition_patient_clinical_status_search_test
      test from: :us_core_v400_condition_patient_category_search_test
      test from: :us_core_v400_condition_read_test
      test from: :us_core_v400_condition_provenance_revinclude_search_test
      test from: :us_core_v400_condition_validation_test
      test from: :us_core_v400_condition_must_support_test
      test from: :us_core_v400_condition_reference_resolution_test
    end
  end
end
