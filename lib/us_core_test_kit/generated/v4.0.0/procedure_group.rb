...
read each reference found and will fail if any attempted read fails.
      ...
      id :us_core_v400_procedure
      run_as_group

      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'procedure', 'metadata.yml')))
      end
  
      test from: :us_core_v400_procedure_patient_search_test
      test from: :us_core_v400_procedure_patient_code_date_search_test
      test from: :us_core_v400_procedure_patient_date_search_test
      test from: :us_core_v400_procedure_patient_status_search_test
      test from: :us_core_v400_procedure_read_test
      test from: :us_core_v400_procedure_provenance_revinclude_search_test
      test from: :us_core_v400_procedure_validation_test
      test from: :us_core_v400_procedure_must_support_test
      test from: :us_core_v400_procedure_reference_resolution_test
    end
  end
end
