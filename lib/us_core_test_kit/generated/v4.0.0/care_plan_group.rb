...
read succeeds.
      ...
      test from: :us_core_v400_care_plan_patient_category_search_test
      test from: :us_core_v400_care_plan_patient_category_status_date_search_test
      test from: :us_core_v400_care_plan_patient_category_status_search_test
      test from: :us_core_v400_care_plan_patient_category_date_search_test
      test from: :us_core_v400_care_plan_read_test
      test from: :us_core_v400_care_plan_provenance_revinclude_search_test
      test from: :us_core_v400_care_plan_validation_test
      test from: :us_core_v400_care_plan_must_support_test
      test from: :us_core_v400_care_plan_reference_resolution_test
    end
  end
end
