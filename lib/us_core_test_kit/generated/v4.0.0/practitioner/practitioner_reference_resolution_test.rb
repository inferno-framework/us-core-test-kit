...
module USCoreTestKit
  module USCoreV400
    class PractitionerReferenceResolutionTest < Inferno::Test
      ...
      title 'MustSupport references within Practitioner resources can be read'
      description %(
        This test will attempt to read MustSupport references found in the
        resources from the first search. This test will look through the Practitioner resources
