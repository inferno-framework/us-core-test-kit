...
read succeeds.
      ...
      id :us_core_v400_head_circumference
      run_as_group
      ...
      test from: :us_core_v400_head_circumference_patient_code_search_test
      test from: :us_core_v400_head_circumference_patient_category_status_search_test
      test from: :us_core_v400_head_circumference_patient_code_date_search_test
      test from: :us_core_v400_head_circumference_patient_category_search_test
      test from: :us_core_v400_head_circumference_patient_category_date_search_test
      test from: :us_core_v400_head_circumference_read_test
      test from: :us_core_v400_head_circumference_provenance_revinclude_search_test
      test from: :us_core_v400_head_circumference_validation_test
      test from: :us_core_v400_head_circumference_must_support_test
      test from: :us_core_v400_head_circumference_reference_resolution_test
    end
  end
end
