...
read each reference found and will fail if any attempted read fails.
      ...
      test from: :us_core_v400_document_reference__id_search_test
      test from: :us_core_v400_document_reference_patient_category_search_test
      test from: :us_core_v400_document_reference_patient_status_search_test
      test from: :us_core_v400_document_reference_patient_type_period_search_test
      test from: :us_core_v400_document_reference_patient_type_search_test
      test from: :us_core_v400_document_reference_patient_category_date_search_test
      test from: :us_core_v400_document_reference_read_test
      test from: :us_core_v400_document_reference_provenance_revinclude_search_test
