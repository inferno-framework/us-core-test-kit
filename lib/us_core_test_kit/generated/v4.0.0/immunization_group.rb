...
read each reference found and will fail if any attempted read fails.
      ...
      test from: :us_core_v400_immunization_patient_search_test
      test from: :us_core_v400_immunization_patient_status_search_test
      test from: :us_core_v400_immunization_patient_date_search_test
      test from: :us_core_v400_immunization_read_test
      test from: :us_core_v400_immunization_provenance_revinclude_search_test
      test from: :us_core_v400_immunization_validation_test
      test from: :us_core_v400_immunization_must_support_test
      test from: :us_core_v400_immunization_reference_resolution_test
    end
  end
end
