...
must contain resources conforming to the Observation Body Height Profile as
...
the [Observation Body Height Profile](http://hl7.org/fhir/StructureDefinition/bodyheight). Each element is checked against
...
read succeeds.
      ...
      test from: :us_core_v311_bodyheight_patient_code_search_test
      test from: :us_core_v311_bodyheight_patient_category_date_search_test
      test from: :us_core_v311_bodyheight_patient_category_status_search_test
      test from: :us_core_v311_bodyheight_patient_code_date_search_test
      test from: :us_core_v311_bodyheight_patient_category_search_test
      test from: :us_core_v311_bodyheight_read_test
      test from: :us_core_v311_bodyheight_provenance_revinclude_search_test
      test from: :us_core_v311_bodyheight_validation_test
      test from: :us_core_v311_bodyheight_must_support_test
      test from: :us_core_v311_bodyheight_reference_resolution_test
    end
  end
end
