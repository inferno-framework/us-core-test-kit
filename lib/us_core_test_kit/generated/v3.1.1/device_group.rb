...
fail if any attempted read fails.
      ...
      test from: :us_core_v311_device_patient_search_test
      test from: :us_core_v311_device_patient_type_search_test
      test from: :us_core_v311_device_read_test
      test from: :us_core_v311_device_provenance_revinclude_search_test
      test from: :us_core_v311_device_validation_test
      test from: :us_core_v311_device_must_support_test
      test from: :us_core_v311_device_reference_resolution_test
    end
  end
end
