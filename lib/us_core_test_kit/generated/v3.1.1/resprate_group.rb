...
fail if any attempted read fails.
      ...
      test from: :us_core_v311_resprate_patient_code_search_test
      test from: :us_core_v311_resprate_patient_category_date_search_test
      test from: :us_core_v311_resprate_patient_category_status_search_test
      test from: :us_core_v311_resprate_patient_code_date_search_test
      test from: :us_core_v311_resprate_patient_category_search_test
      test from: :us_core_v311_resprate_read_test
      test from: :us_core_v311_resprate_provenance_revinclude_search_test
      test from: :us_core_v311_resprate_validation_test
      test from: :us_core_v311_resprate_must_support_test
      test from: :us_core_v311_resprate_reference_resolution_test
    end
  end
end
