...
read succeeds.
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'bp', 'metadata.yml'), aliases: true))
      end
  
      test from: :us_core_v311_bp_patient_code_search_test
      test from: :us_core_v311_bp_patient_category_date_search_test
      test from: :us_core_v311_bp_patient_category_status_search_test
      test from: :us_core_v311_bp_patient_code_date_search_test
      test from: :us_core_v311_bp_patient_category_search_test
      test from: :us_core_v311_bp_read_test
      test from: :us_core_v311_bp_provenance_revinclude_search_test
      test from: :us_core_v311_bp_validation_test
      test from: :us_core_v311_bp_must_support_test
      test from: :us_core_v311_bp_reference_resolution_test
    end
  end
end
