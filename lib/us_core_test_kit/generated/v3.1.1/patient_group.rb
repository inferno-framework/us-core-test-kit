...
fail if any attempted read fails.
      ...
      test from: :us_core_v311_patient__id_search_test
      test from: :us_core_v311_patient_identifier_search_test
      test from: :us_core_v311_patient_name_search_test
      test from: :us_core_v311_patient_birthdate_family_search_test
      test from: :us_core_v311_patient_family_gender_search_test
      test from: :us_core_v311_patient_birthdate_name_search_test
      test from: :us_core_v311_patient_gender_name_search_test
      test from: :us_core_v311_patient_read_test
      test from: :us_core_v311_patient_provenance_revinclude_search_test
      test from: :us_core_v311_patient_validation_test
      test from: :us_core_v311_patient_must_support_test
      test from: :us_core_v311_patient_reference_resolution_test
    end
  end
end
