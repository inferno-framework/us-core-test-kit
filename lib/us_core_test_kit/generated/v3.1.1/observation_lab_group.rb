...
read succeeds.
      ...
      id :us_core_v311_observation_lab
      run_as_group

      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'observation_lab', 'metadata.yml')))
      end
  
      test from: :us_core_v311_observation_lab_patient_category_search_test
      test from: :us_core_v311_observation_lab_patient_category_date_search_test
      test from: :us_core_v311_observation_lab_patient_category_status_search_test
      test from: :us_core_v311_observation_lab_patient_code_date_search_test
      test from: :us_core_v311_observation_lab_patient_code_search_test
      test from: :us_core_v311_observation_lab_read_test
      test from: :us_core_v311_observation_lab_provenance_revinclude_search_test
      test from: :us_core_v311_observation_lab_validation_test
      test from: :us_core_v311_observation_lab_must_support_test
      test from: :us_core_v311_observation_lab_reference_resolution_test
    end
  end
end
