...
module USCoreTestKit
  module USCoreV800_BALLOT
    class SmartGranularScopesGroup < BaseSmartGranularScopesGroup
      id :us_core_v800_ballot_smart_granular_scopes
...
#{scopes_string(SMART_GRANULAR_SCOPES_GROUP1['v800_ballot'])}
        ...
        .config(
          inputs: {
            requested_scopes: {
              ...
              default: groups.first.default_group_scopes('v800_ballot')
            }
          },
          options: {
            required_scopes: SMART_GRANULAR_SCOPES_GROUP1['v800_ballot']
          }
        )
