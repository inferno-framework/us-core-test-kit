...
module USCoreTestKit
  module USCoreV800
    class SmartGranularScopesGroup < BaseSmartGranularScopesGroup
      ...
      verifies_requirements 'hl7.fhir.us.core_8.0.0@158',
                            'hl7.fhir.us.core_8.0.0@159',
                            'hl7.fhir.us.core_8.0.0@160',
                            'hl7.fhir.us.core_8.0.0@161',
                            'hl7.fhir.us.core_8.0.0@162',
                            'hl7.fhir.us.core_8.0.0@163',
                            'hl7.fhir.us.core_8.0.0@164',
                            'hl7.fhir.us.core_8.0.0@165'
