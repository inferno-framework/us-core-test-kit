  ...
  module USCoreV800
    class CapabilityStatementGroup < Inferno::TestGroup
      ...
      test from: :us_core_json_support,
           verifies_requirements: ['hl7.fhir.us.core_8.0.0@540']

      test from: :us_core_profile_support do
        verifies_requirements 'hl7.fhir.us.core_8.0.0@16', 'hl7.fhir.us.core_8.0.0@533',
                              'hl7.fhir.us.core_8.0.0@534'
        config(
          options: { us_core_profiles: PROFILES.values.flatten }
        )
      end

      test from: :us_core_instantiate do
        optional
      end
    end
  end
