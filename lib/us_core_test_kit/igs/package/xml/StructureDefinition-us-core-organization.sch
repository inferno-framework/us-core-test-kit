...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization/f:identifier">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="f:value/f:matches(value,/^[0-9]{10}$/)">NPI must be 10 digits</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="f:value/f:matches(value,/^[0-9]{2}D[0-9]{7}$/)">CLIA number must be 10 digits with a letter &quot;D&quot; in third position</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="f:value/f:matches(value,/^[0-9]{5}$/)">NAIC must be 5 digits</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
