...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency 'inferno_core', '>= 0.4.37'
  spec.add_development_dependency 'smart_app_launch_test_kit', '>= 0.4.5'
  spec.add_development_dependency 'tls_test_kit', '~> 0.2.0'
